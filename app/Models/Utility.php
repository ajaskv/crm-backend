...
',
    ...
    {
        return "QUOTE". sprintf("%05d", $number);
    }
    ...
    public static function ipoNumberFormat($settings, $number)
    {
        $order = 2000 + (int) $number;
        return "LPO" . sprintf("%05d", $order);
    }
    ...
    public static function invoice_ChartOfAccount($created_id)
    {
        //Account Recievable
        $type = ChartOfAccountType::where(['name' => "Assets", 'created_by' => $created_id])->first()->id;
        $sub_type = ChartOfAccountSubType::where(['name' => "Current Asset"])->where('type', $type)->first()->id;
        ...
        $account->description = "Account Receivable details";
        $account->is_enabled = 1;
        $account->editable = 0;
        $account->created_by = $created_id;
        $account->save();

        //Account payable
        $type = ChartOfAccountType::where(['name' => "Liabilities", 'created_by' => $created_id])->first()->id;
        $sub_type = ChartOfAccountSubType::where(['name' => "Current Liability"])->where('type', $type)->first()->id;
        $account = new ChartOfAccount();
        $account->name = "Account Payable";
        $account->account_name = "account-payable";
        $account->code = "20002";
        $account->type = $type;
        $account->sub_type = $sub_type;
        $account->description = "Account Payable details";
        $account->is_enabled = 1;
        $account->editable = 0;
        $account->created_by = $created_id;
        $account->save();
        ...
        $sub_type = ChartOfAccountSubType::where(['name' => "Current Asset"])->where('type', $type)->first()->id;
        $account = new ChartOfAccount();
        $account->name = "Input Tax";
        $account->account_name = "input-tax";
        $account->code = "10003";
        $account->type = $type;
        $account->sub_type = $sub_type;
        $account->description = "Input Tax details";
        $account->is_enabled = 1;
        $account->editable = 0;
        $account->created_by = $created_id;
        $account->save();
        ...
        $sub_type = ChartOfAccountSubType::where(['name' => "Current Liability"])->where('type', $type)->first()->id;
        $account = new ChartOfAccount();
        $account->account_name = "tax-payable";
        $account->name = "Tax Payable";
        $account->code = "20001";
        $account->type = $type;
        $account->sub_type = $sub_type;
        $account->description = "Tax Payable details";
        $account->is_enabled = 1;
        $account->editable = 0;
        $account->created_by = $created_id;
        $account->save();
        ...
        //Cash
        $type = ChartOfAccountType::where(['name' => "Assets", 'created_by' => $created_id])->first()->id;
        $sub_type = ChartOfAccountSubType::where(['name' => "Bank & Cash"])->where('type', $type)->first()->id;
        $account = new ChartOfAccount();
        $account->name = "Invoice Cash";
        $account->account_name = "invoice-cash";
        $account->code = "10001";
        $account->type = $type;
        $account->sub_type = $sub_type;
        $account->description = "Invoice details";
        $account->editable = 0;
        $account->is_enabled = 1;
        $account->created_by = $created_id;
        $account->save();
        //Sales
        $type = ChartOfAccountType::where(['name' => "Income", 'created_by' => $created_id])->first()->id;
        $sub_type = ChartOfAccountSubType::where(['name' => "Sales"])->where('type', $type)->first()->id;
        $account = new ChartOfAccount();
        ...
        $account->type = $type;
        $account->sub_type = $sub_type;
        $account->description = "Sales details";
        $account->editable = 0;
        $account->is_enabled = 1;
        $account->created_by = $created_id;
        $account->save();
