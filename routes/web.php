...
Route::get('/reccurring-invoice', function () {
    Invoice::reccurring();
});
...
Route::prefix('customer')->as('customer.')->group(
    function () {
        ...
        Route::get('quotation', 'QuotationController@customerProposal')->name('quotation')->middleware(
            [
                'auth:customer',
                'XSS',
                'revalidate',
        ...
        Route::get('quotation/{id}/show', 'QuotationController@customerProposalShow')->name('quotation.show')->middleware(
            [
                'auth:customer',
                'XSS',
                'revalidate',
...
Route::group(
    [
        ...
        Route::post('mail-setting', 'SystemController@saveMailSettings')->name('mail.settings');
        Route::post('mailchimp-setting', 'SystemController@saveMailChimpSettings')->name('mailchimp.settings');

        Route::get('print-setting', 'SystemController@printIndex')->name('print.setting');
        Route::get('set-view/{type}/{value}', 'SystemController@setView')->name('setview.setting');
...
Route::get('invoice/cheque/pay/{id}', 'InvoiceController@chequePaid')->name('invoice.cheque.pay')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::get('invoice/cheque/cancel/{id}', 'InvoiceController@chequeNotPaid')->name('invoice.cheque.cancel')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::get('revenue/cheque/pay/{id}', 'RevenueController@chequePaid')->name('revenue.cheque.pay')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::get('revenue/cheque/cancel/{id}', 'RevenueController@chequeNotPaid')->name('revenue.cheque.cancel')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::group(
    [
        ...
        Route::get('bill/cheque/pay/{id}', 'BillController@chequePaid')->name('bill.cheque.pay');
        Route::get('bill/cheque/cancel/{id}', 'BillController@chequeNotPaid')->name('bill.cheque.cancel');
    }
);
...
Route::get('payment/cheque/pay/{id}', 'PaymentController@chequePaid')->name('payment.cheque.pay')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::get('payment/cheque/cancel/{id}', 'PaymentController@chequeNotPaid')->name('payment.cheque.cancel')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::get('quotation/pdf/{id}', 'QuotationController@proposal')->name('quotation.pdf')->middleware(
    [
        'XSS',
        'revalidate',
    ]
...
Route::group(
    [
        ...
        Route::get('quotation/{id}/status/change', 'QuotationController@statusChange')->name('quotation.status.change');
        Route::get('quotation/{id}/convert', 'QuotationController@convert')->name('quotation.convert');
        Route::get('quotation/{id}/duplicate', 'QuotationController@duplicate')->name('quotation.duplicate');
        Route::post('quotation/product/destroy', 'QuotationController@productDestroy')->name('quotation.product.destroy');
        Route::post('quotation/customer', 'QuotationController@customer')->name('quotation.customer');
        Route::post('quotation/product', 'QuotationController@product')->name('quotation.product');
        Route::get('quotation/items', 'QuotationController@items')->name('quotation.items');
        Route::get('quotation/{id}/sent', 'QuotationController@sent')->name('quotation.sent');
        Route::get('quotation/{id}/resent', 'QuotationController@resent')->name('quotation.resent');

        Route::resource('quotation', 'QuotationController');
        Route::get('quotation/create/{cid}', 'QuotationController@create')->name('quotation.create');
    }
);

Route::get(
    '/quotation/preview/{template}/{color}', [
        'as' => 'quotation.preview',
        'uses' => 'QuotationController@previewProposal',
    ]
);
Route::post(
    '/quotation/template/setting', [
        'as' => 'quotation.template.setting',
        'uses' => 'QuotationController@saveProposalTemplateSettings',
    ]
);
...
Route::get(
    'customer/{id}/make_active', [
        'as' => 'convert.customer',
        'uses' => 'CustomerController@makeActive',
    ]
)->middleware(
    [
        'auth',
...
Route::get('/customer/quotation/{id}/', 'QuotationController@invoiceLink')->name('quotation.link.copy');
