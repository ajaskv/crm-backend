...
@section('action-button')
    <div class="all-button-box row d-flex justify-content-end">
        ...
        <div class="col-auto">
            <a href="#" class="apply-btn" onclick="document.getElementById('product_service').submit(); return false;"
        ...
        <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
            <a href="#" data-url="{{ route('productservice.create') }}" data-ajax-popup="true"
                data-title="{{ __('Create New Product') }}" class="btn btn-xs btn-white btn-icon-only width-auto">
                            ...
                            <tbody>
                                @foreach ($productServices as $productService)
                                    <tr class="font-style">
                                        ...
                                        <td>{{ !empty($productService->unit()) ? $productService->unit()->name : '' }}
                                        </td>
