...
@section('action-button')
    <div class="row d-flex justify-content-end">
        ...
        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-12 col-12">
            <div class="all-button-box">
                <a href="{{ route('deals.index') }}" class="btn btn-xs btn-white btn-icon-only width-auto"><i
                                                        ...
                                                        <span>
                                                            ...
                                                            @can('edit deal')
                                                                <a href="#"
                                                                    ...
                                                                    data-title="{{ __('Edit Deal') }}" class="edit-icon"
                                                                    data-toggle="tooltip"
                                                            ...
                                                            @can('delete deal')
                                                                <a href="#" data-title="{{ __('Delete Deal') }}"
                                                                    ...
                                                                    data-confirm-yes="document.getElementById('delete-form-{{ $deal->id }}').submit();"><i
