                        ...
                        <div style="display: inline-block;">
                            ...
                            @if (!empty(\Auth::user()->avatar))
                                <div class="avatar av-s header-avatar"
                                    style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px;background-image: url('{{ asset('/storage/uploads/avatar/' . \Auth::user()->avatar) }}');">
                                </div>
                            @else
    ...
    <div class="app-modal" data-name="settings">
        <div class="app-modal-container">
            <div class="app-modal-card" data-name="settings" data-modal='0'>
                <form id="updateAvatar" action="{{ route('avatar.update') }}" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    ...
                    <div class="app-modal-body">
                        ...
                        <p class="divider"></p>
                        <p class="app-modal-header">{{ __('Change') }} {{ config('chatify.name') }}
                            {{ __('Color') }}</p>
