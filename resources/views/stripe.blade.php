                ...
                <div class="row our-system">
                    <ul class="nav nav-tabs">
                        ...
                        @if ($admin_payment_setting['is_stripe_enabled'] == 'on' && !empty($admin_payment_setting['stripe_key']) && !empty($admin_payment_setting['stripe_secret']))
                            <li>
                                <a data-toggle="tab" class="active" id="contact-tab1"
                        ...
                        @if (isset($admin_payment_setting['is_flutterwave_enabled']) && $admin_payment_setting['is_flutterwave_enabled'] == 'on')
                            <li>
                                <a data-toggle="tab" id="contact-tab4"
                        ...
                        @if (isset($admin_payment_setting['is_mercado_enabled']) && $admin_payment_setting['is_mercado_enabled'] == 'on')
                            <li>
                                <a data-toggle="tab" id="contact-tab6"
                                    href="#mercado_payment">{{ __('Mercado Pago') }}</a>
                            </li>
                        @endif
                        ...
                        @if (isset($admin_payment_setting['is_paymentwall_enabled']) && $admin_payment_setting['is_paymentwall_enabled'] == 'on')
                            <li>
                                <a data-toggle="tab" id="contact-tab11"
                                    href="#paymentwall_payment">{{ __('PaymentWall') }}</a>
                            </li>
                        @endif
                    </ul>
                </div>
                                    ...
                                    <div class="border p-3 mb-3 rounded stripe-payment-div">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 text-sm-right mt-3 mt-sm-0">
                                                <img src="{{ asset('public/assets/img/payments/master.png') }}"
                                                    height="24" alt="master-card-img">
                                                <img src="{{ asset('public/assets/img/payments/discover.png') }}"
                                                    height="24" alt="discover-card-img">
                                                <img src="{{ asset('public/assets/img/payments/visa.png') }}" height="24"
                                                    alt="visa-card-img">
                                                <img src="{{ asset('public/assets/img/payments/american express.png') }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="card-name-on"
                                                        class="form-control-label text-dark">{{ __('Name on card') }}</label>
                                            ...
                                            <div class="col-auto my-auto">
                                                <a href="#" class="apply-btn apply-coupon" data-toggle="tooltip"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="text-sm-right">
                                                <input type="submit" id="pay_with_paymentwall"
                                                    value="{{ __('Pay Now') }}" class="btn-create badge-blue">
                                            </div>
                                        </div>
                                    </div>
                                </form>
