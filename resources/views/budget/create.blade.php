    ...
    <div class="card bg-none card-box">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                {{ Form::select('period', $periods, null, ['class' => 'form-control select2 period', 'required' => 'required']) }}
                ...
                <div class="table-responsive budget_plan d-block" id="monthly">
                                    ...
                                    @foreach ($monthList as $month)
                                        <td>
                                            <input type="number"
                                                ...
                                                data-month="{{ $month }}"
                                                name="income[{{ $productService->id }}][{{ $month }}]" value="0"
                                    ...
                                    @foreach ($monthList as $month)
                                        <td>
                                            <input type="number"
                                                ...
                                                data-month="{{ $month }}"
                                                name="expense[{{ $productService->id }}][{{ $month }}]" value="0"
                    ...
                    <div class="col-12 text-right">
                        ...
                        <input type="button" value="{{ __('Cancel') }}"
                            onclick="location.href = '{{ route('budget.index') }}';"
