                            ...
                            <tbody>
                                @foreach ($proposals as $proposal)
                                    ...
                                    @else
                                        @if (\Auth::guard('customer')->check())
                                        <a
                                            href="{{ route('customer.proposal.show', \Crypt::encrypt($proposal->id)) }}">{{ AUth::user()->quotationNumberFormat($proposal->proposal_id) }}
                                        </a>
                                    @else
                                        <a href="{{ route('proposal.show', \Crypt::encrypt($proposal->id)) }}">{{ AUth::user()->quotationNumberFormat($proposal->proposal_id) }}
                                        </a>
                                    @endif
                                        @endif
