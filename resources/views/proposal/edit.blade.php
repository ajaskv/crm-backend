                        ...
                        success: function(data) {
                            ...
                            if (proposalItems != null) {
                                var itemTaxPrice = parseFloat((totalItemTaxRate / 100) * (
                                    proposalItems.price * proposalItems.quantity));
                            } else {
                        ...
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                <div class="input-group">
                                    ...
                                    {{ Form::select('customer_id', $customers, null, ['class' => 'form-control select2 ', 'id' => 'customer', 'data-url' => route('proposal.customer'), 'required' => 'required']) }}
                                </div>
                            </div>
                        ...
                        <table class="table table-striped mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tbody class="ui-sortable" data-repeater-item>
                                <tr>
                                    ...
                                    <td width="25%">
                                        {{ Form::select('item', $product_services, null, ['class' => 'form-control select2 item', 'data-url' => route('proposal.product')]) }}
                                    </td>
                                    <td>
