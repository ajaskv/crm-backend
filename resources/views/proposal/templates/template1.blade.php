                                ...
                                <div data-v-f2a183a6="" class="d-header"
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-inner">
                                        ...
                                        <div data-v-f2a183a6="" class="d-header-50 d-right">
                                            <div data-v-f2a183a6="" class="d-title">
                                            ...
                                            <table data-v-f2a183a6="" class="summary-table">
                                                <tbody data-v-f2a183a6="">
                                                    <tr>
                                                        ...
                                                        @else
                                                        {{ Utility::quotationNumberFormat($settings, $proposal->proposal_id) }}
                                                    ...
                                                    <tr>
                                                        <td>{{ __('Issue Date') }}:</td>
                                                        <td>{{ Utility::dateFormat($settings, $proposal->issue_date) }}
                                                        </td>
                                                    </tr>
                                        ...
                                        <div data-v-f2a183a6="" class="d-table">
                                            <div data-v-f2a183a6="" class="d-table">
                                                <div data-v-f2a183a6="" class="d-table-tr"
                                                    style="background: {{ $color }};color:{{ $font_color }}">
                                                    <div class="d-table-th w-6">{{ __('Item') }}</div>
                                                    <div class="d-table-th w-1">{{ __('Qty') }}</div>
                                                    <div class="d-table-th w-2">{{ __('Rate') }}</div>
                                                    ...
                                                    @endif
                                                    <div class="d-table-th w-7">{{ __('Description') }}</div>
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary">
                                                            ...
                                                            @if ($proposal->getTotalDiscount())
                                                                <div data-v-f2a183a6="" class="d-table-summary-item">
                                                                    ...
                                                                    <div data-v-f2a183a6="" class="d-table-value">
                                                                        {{ Utility::priceFormat($settings, $proposal->getTotalDiscount()) }}
                                                                    </div>
                                                                </div>
                                                            @endif
                                                        @endif
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-summary-item"
                                                            ...
                                                            <div data-v-f2a183a6="" class="d-table-label">
                                                                {{ __('Total') }}:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">
                                                                {{ Utility::priceFormat($settings, $proposal->getSubTotal() - $proposal->getTotalDiscount() + $proposal->getTotalTax()) }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
