                                ...
                                <div class="timeline-block">
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        <small><i class="fas fa-clock mr-1"></i>{{ __('Created on ') }}
                                            {{ \Auth::user()->dateFormat($proposal->issue_date) }}</small>
                                    </div>
                                </div>
                                <div class="timeline-block">
                                    ...
                                    <div class="timeline-content">
                                        <div class="text-sm h6 ">
                                            {{\Auth::user()->pro_quo == 0 ?('Send Proposal'): __('Send Quotation') }}
                                        </div>
                                        ...
                                        @if ($proposal->status != 0)
                                            <small>{{ __('Sent on') }}
                                                {{ \Auth::user()->dateFormat($proposal->send_date) }}</small>
                                        @else
                                ...
                                <div class="timeline-block">
                                    ...
                                    <div class="timeline-content">
                                        <span class="text-sm h6 ">
                                            {{\Auth::user()->pro_quo == 0 ?('Proposal Status'): __('Quotation Status') }}
                                            </span>
                ...
                <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                    <div class="all-button-box mx-2">
                        <a href="{{ route('proposal.resent', $proposal->id) }}"
                            class="btn btn-xs btn-white btn-icon-only width-auto">{{ __('Resend Proposal') }}</a>
                    </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12">
                                    <h2>
                                        ...
                                        {{ Auth::user()->proposalNumberFormat($proposal->proposal_id) }}
                                            ...
                                            @else
                                            {{ Auth::user()->quotationNumberFormat($proposal->proposal_id) }}
