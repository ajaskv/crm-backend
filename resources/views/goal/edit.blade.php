<div class="card bg-none card-box">
    ...
    <div class="row">
        ...
        <div class="form-group  col-md-6">
            ...
            {{ Form::text('from', null, ['class' => 'form-control custom-datepicker']) }}
        </div>
        <div class="form-group  col-md-6">
            {{ Form::label('to', __('To'), ['class' => 'form-control-label']) }}
            {{ Form::text('to', null, ['class' => 'form-control custom-datepicker']) }}
        </div>
        <div class="form-group col-md-12">
            <div class="custom-control custom-checkbox">
                <input class="custom-control-input" type="checkbox" name="is_display" id="is_display"
