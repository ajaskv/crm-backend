        ...
        @can('create transfer')
            ...
            <div class="col-auto">
                <div class="btn-box">
                    ...
                    {{ Form::text('date', isset($_GET['date']) ? $_GET['date'] : '', ['class' => 'form-control month-btn datepicker-range']) }}
                </div>
            </div>
            <div class="col-auto">
                <div class="btn-box">
                    {{ Form::label('f_account', __('From Account'), ['class' => 'text-type']) }}
                    {{ Form::select('f_account', $account, isset($_GET['f_account']) ? $_GET['f_account'] : '', ['class' => 'form-control select2']) }}
                </div>
            </div>
            <div class="col-auto">
                <div class="btn-box">
                    {{ Form::label('t_account', __('To Account'), ['class' => 'text-type']) }}
                    {{ Form::select('t_account', $account, isset($_GET['t_account']) ? $_GET['t_account'] : '', ['class' => 'form-control select2']) }}
                </div>
            </div>
            <div class="col-auto my-custom">
                <a href="#" class="apply-btn"
                    onclick="document.getElementById('bank-transfer_form').submit(); return false;" data-toggle="tooltip"
                    data-original-title="{{ __('apply') }}">
                    <span class="btn-inner--icon"><i class="fas fa-search"></i></span>
                </a>
                <a href="{{ route('bank-transfer.index') }}" class="reset-btn" data-toggle="tooltip"
            ...
            <div class="col-2 my-custom-btn">
                <div class="all-button-box">
                    <a href="#" data-url="{{ route('bank-transfer.create') }}" data-ajax-popup="true"
                        data-title="{{ __('Create New Transfer Amount') }}"
                                                ...
                                                <span>
                                                    @can('edit transfer')
                                                        <a href="#" class="edit-icon"
                                                            ...
                                                            data-title="{{ __('Edit Transfer Amount') }}"
