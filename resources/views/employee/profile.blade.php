        ...
        <div class="col-xl-3 col-lg-3 col-md-4">
            ...
            <div class="all-select-box">
                <div class="btn-box">
                    ...
                    {{ Form::select('branch', $brances, isset($_GET['branch']) ? $_GET['branch'] : '', ['class' => 'select-box select2']) }}
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-lg-3 col-md-4">
            <div class="all-select-box">
                <div class="btn-box">
                    ...
                    {{ Form::select('department', $departments, isset($_GET['department']) ? $_GET['department'] : '', ['class' => 'select-box select2']) }}
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-lg-3 col-md-4">
