    ...
    @can('create revenue')
        <div class="row d-flex justify-content-end">
            ...
            <div class="col-2">
                <div class="all-select-box">
                    <div class="btn-box">
                        ...
                        {{ Form::text('date', isset($_GET['date']) ? $_GET['date'] : null, ['class' => 'month-btn form-control datepicker-range']) }}
                    </div>
                </div>
            </div>
            <div class="col-auto">
            ...
            <div class="col-auto my-custom">
                <a href="#" class="apply-btn" onclick="document.getElementById('revenue_form').submit(); return false;"
                    data-toggle="tooltip" data-original-title="{{ __('apply') }}">
                    <span class="btn-inner--icon"><i class="fas fa-search"></i></span>
                </a>
                <a href="{{ route('revenue.index') }}" class="reset-btn" data-toggle="tooltip"
            ...
            <div class="col-2 my-custom-btn">
                <div class="all-button-box">
                    <a href="#" data-url="{{ route('revenue.create') }}" data-ajax-popup="true"
                        data-title="{{ __('Create New Revenue') }}" class="btn btn-xs btn-white btn-icon-only width-auto">
                                                ...
                                                <span>
                                                    ...
                                                    @if($revenue->cheque == 1)
                                                        <a href="#" class="edit-icon"
                                                            ...
                                                            data-ajax-popup="true" data-title="{{ __('Edit Revenue') }}"
                                                    ...
                                                    @endcan
                                                    @if($revenue->cheque == 1)
                                                        <a href="{{ route('revenue.cheque.pay', $revenue->id) }}" class="edit-icon" data-toggle="tooltip"
                                                            data-original-title="{{ __('Cheque Pay') }}"
                                                            data-confirm="{{ __('Are You Sure?') . '|' . __('This action can not be undone. Do you want to continue?') }}"
                                                            data-confirm-yes="window.location.href = '{{ route('revenue.cheque.pay', $revenue->id) }}'"; >
                                                            <i class="fas fa-thumbs-up ,"></i>
                                                        </a>
                                                        <a href="{{ route('revenue.cheque.cancel', $revenue->id) }}" class="delete-icon" data-toggle="tooltip"
                                                            data-original-title="{{ __('Cheque Cancel') }}"
                                                            data-confirm="{{ __('Are You Sure?') . '|' . __('This action can not be undone. Do you want to continue?') }}"
                                                            data-confirm-yes="window.location.href = '{{ route('revenue.cheque.cancel', $revenue->id) }}'"; >
