                        ...
                        <li class="list-group-item px-0">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    ...
                                    <div class="h6 mb-0">{{ \Auth::user()->dateFormat($support->created_at) }}
                                    </div>
                                </div>
                            </div>
                        </li>
            ...
            <div class="card">
                <div class="card-body">
                    @if ($support->status == 'Open')
                        ...
                        {{ Form::open(['route' => ['support.reply.answer', $support->id]]) }}
                        ...
                        <div class="text-right">
                            <div class=" mb-2 ml-2">
                                {{ Form::submit(__('Send'), ['class' => 'btn-create badge-blue']) }}
                            </div>
                        </div>
                        {{ Form::close() }}
                    @endif
                            ...
                            @foreach ($replyes as $reply)
                                <div class="list-group-item list-group-item-action">
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <img alt="" class="avatar rounded-circle mr-2"
                                        ...
                                        <div class="flex-fill ml-3">
                                            <div class="h6 text-sm mb-0">
                                                {{ !empty($reply->users) ? $reply->users->name : '' }}
                                                <small class="float-right text-muted"> {{ $reply->created_at }}</small>
                                            </div>
