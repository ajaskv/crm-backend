...
@section('action-button')
    ...
    <a href="#" data-size="lg" data-url="{{ route('support.create') }}" data-toggle="tooltip" data-ajax-popup="true"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($support->status == 'Open')
                                            <span
                                                class="text-capitalize badge badge-success rounded-pill badge-sm">{{ __(\App\Models\Support::$status[$support->status]) }}</span>
                                        @elseif($support->status == 'Close')
                                            <span
                                                class="text-capitalize badge badge-danger rounded-pill badge-sm">{{ __(\App\Models\Support::$status[$support->status]) }}</span>
                                        @elseif($support->status == 'On Hold')
                                            <span
                                                class="text-capitalize badge badge-warning rounded-pill badge-sm">{{ __(\App\Models\Support::$status[$support->status]) }}</span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="text-right">
                                        <div class="actions ml-3">
                                            <a href="{{ route('support.reply', \Crypt::encrypt($support->id)) }}"
                                                data-title="{{ __('Support Reply') }}" class="action-item"
                                                data-toggle="tooltip" data-original-title="{{ __('Reply') }}">
