            ...
            <div class="container pt-5">
                <div class="row row-grid justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <p class="lead lh-180">{{ __('Work there. Find the dream job you’ve always wanted..') }}
                        </p>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div class="media align-items-center">
                                                    <div>
                                                        <span class="avatar bg-dark text-white mr-4"
                                            ...
                                            <td><i class="fas fa-map-marker mr-3"></i><span
