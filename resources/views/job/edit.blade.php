                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="my-4">
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="applicant[]" value="dob"
                            ...
                            <div class="form-group">
                                ...
                                <div class="my-4">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="check-profile">{{ __('Profile Image') }}
                                        </label>
                                    </div>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="visibility[]"
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control summernote-simple" name="description" id="exampleFormControlTextarea1"
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control summernote-simple" name="requirement" id="exampleFormControlTextarea2"
                                rows="8">{{ $job->requirement }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
