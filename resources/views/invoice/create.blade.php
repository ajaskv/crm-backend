                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group" id="customer-box">
                                <div class="input-group">
                                    ...
                                    <label class='form-control-label col-md-12'>Customer</label>
                                    {{-- <select class="select2" name="customer_id" id="customer" data-url="{{ route('invoice.customer') }}" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            ...
                                            {{ Form::number('reccurring_limit', '', ['class' => 'form-control number']) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            <span><i class="fas fa-text"></i></span>
                                            {{ Form::number('reccurring_intervel', '', ['class' => 'form-control number']) }}
                                        </div>
                                    </div>
                                </div>
