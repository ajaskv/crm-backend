                                        ...
                                        <div data-v-f2a183a6="" class="d-header-50 d-right">
                                            ...
                                            <table data-v-f2a183a6="" class="summary-table">
                                                <tbody data-v-f2a183a6="">
                                                    <tr>
                                                        <td>{{ __('Number') }}:</td>
                                                        <td>{{ Utility::invoiceNumberFormat($settings, $invoice->invoice_id) }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>{{ __('Issue Date') }}:</td>
                                                        <td>{{ Utility::dateFormat($settings, $invoice->issue_date) }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>{{ __('Due Date') }}:</td>
                                                        <td>{{ Utility::dateFormat($settings, $invoice->due_date) }}
                                                        </td>
                                                    </tr>
