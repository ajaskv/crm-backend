                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="custom-control custom-checkbox mt-4">
                                        <input class="custom-control-input" type="checkbox" name="reccurring"
                                            id="reccurring" {{ $invoice->recurring == 1 ? 'checked' : '' }}>
                                        <label class="custom-control-label form-control-label"
                                            for="reccurring">{{ __('Reccurring') }}</label>
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('reccurring_limit', __('Reccurring Cycle'), ['class' => 'form-control-label']) }}
                                        <div class="form-icon-user">
                                            <span><i class="fas fa-text"></i></span>
                                            {{ Form::number('reccurring_limit', $invoice->recurring_limit, ['class' => 'form-control number']) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('reccurring_type', __('Reccurring Type'), ['class' => 'form-control-label']) }}
                                        <select class="form-control" name="reccurring_type" id="reccurring_type">
                                            <option value="DAYS" @if ($invoice->interval_type == 'DAYS') selected @endif>Days
                                            </option>
                                            <option value="MONTH" @if ($invoice->interval_type == 'MONTH') selected @endif>Months
                                            </option>
                                            <option value="YEAR" @if ($invoice->interval_type == 'YEAR') selected @endif>Years
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('reccurring_intervel', __('Reccurring Intervel'), ['class' => 'form-control-label']) }}
                                        <div class="form-icon-user">
                                            <span><i class="fas fa-text"></i></span>
                                            {{ Form::number('reccurring_intervel', $invoice->interval, ['class' => 'form-control number']) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
