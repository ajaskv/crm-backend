                        ...
                        <div class="card-header ">
                            <div class="row">
                                ...
                                @can('create allowance')
                                    <div class="col text-right">
                                        <a href="#" data-url="{{ route('allowances.create', $employee->id) }}" data-size="md"
                                ...
                                @can('create commission')
                                    <div class="col text-right">
                                        <a href="#" data-url="{{ route('commissions.create', $employee->id) }}"
                                            data-size="md" data-ajax-popup="true" data-title="{{ __('Create Commission') }}"
                                            data-toggle="tooltip" data-original-title="{{ __('Create Commission') }}"
                                            class="apply-btn">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                    </div>
                                        ...
                                        @foreach ($commissions as $commission)
                                            <tr>
                                                ...
                                                @if ($commission->type == 'fixed')
                                                    <td>{{ \Auth::user()->priceFormat($commission->amount) }}</td>
                                                @else
                                                    <td>{{ $commission->amount }}% (${{ $commission->tota_allow }})
                                                    </td>
                                                @endif
                                ...
                                @can('create loan')
                                    <div class="col text-right">
                                        <a href="#" data-url="{{ route('loans.create', $employee->id) }}" data-size="md"
                                            data-ajax-popup="true" data-title="{{ __('Create Loan') }}" data-toggle="tooltip"
                                            data-original-title="{{ __('Create Loan') }}" class="apply-btn">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                    </div>
                                @endcan
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                @can('create overtime')
                                    <div class="col text-right">
                                        <a href="#" data-url="{{ route('overtimes.create', $employee->id) }}" data-size="md"
