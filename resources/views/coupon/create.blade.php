    ...
    <div class="row">
            ...
            <div class="d-flex radio-check">
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="manual_code" value="manual" name="icon-input"
                        class="custom-control-input code" checked="checked">
                    <label class="custom-control-label form-control-label"
                        for="manual_code">{{ __('Manual') }}</label>
                </div>
                <div class="custom-control custom-radio custom-control-inline">
        ...
        <div class="form-group col-md-12 d-none" id="auto">
            <div class="row">
                ...
                <div class="col-md-2">
                    <a href="#" class="btn badge-blue btn-xs rounded-pill my-auto text-white" id="code-generate"><i
