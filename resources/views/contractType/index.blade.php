    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('create label')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('contractType.create') }}" data-ajax-popup="true"
                    data-title="{{ __('Create New Contract Type') }}" class="btn btn-xs btn-white btn-icon-only width-auto"><i
                ...
                <tbody class="list">
                    @foreach ($types as $type)
                        <tr class="font-style">
                            ...
                            @if (\Auth::user()->type == 'company')
                                <td class="">
                                    <a href="#" data-url="{{ route('contractType.edit', $type->id) }}"
