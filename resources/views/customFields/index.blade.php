    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('create constant custom field')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('custom-field.create') }}" data-ajax-popup="true"
                    data-title="{{ __('Create New Custom Field') }}" class="btn btn-xs btn-white btn-icon-only width-auto">
                                                ...
                                                <span>
                                                    @can('edit constant custom field')
                                                        <a href="#" class="edit-icon"
                                                            ...
                                                            data-ajax-popup="true" data-title="{{ __('Edit Custom Field') }}"
