<div class="card bg-none card-box">
    ...
    <div class="row">
        ...
        <div class="col-12 form-group">
            {{ Form::label('duration', __('Duration'), ['class' => 'form-control-label']) }} <small
        ...
        <div class="col-12 form-group">
            {{ Form::label('duration', __('Date and  Time'), ['class' => 'form-control-label']) }} <small
                class="font-weight-bold"></small>
                <input type="datetime-local" class="form-control" id="birthdaytime" name="datetime" @if (isset($call->created_at)) value="{{ $call->created_at }}" @endif required >
            {{-- {{ Form::date('datetime', null, ['class' => '', 'placeholder' => '00:35:20', 'step' => '2']) }} --}}
        </div>
        <div class="col-12 form-group">
