<div class="card bg-none card-box">
    {{ Form::model($lead, ['route' => ['leads.convert.to.deal', $lead->id], 'method' => 'POST']) }}
    <div class="row">
        ...
        <div class="col-sm-12 col-md-12">
            <div class="d-flex radio-check">
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" name="client_check" value="new" id="new_client" class="custom-control-input"
                        @if (empty($exist_client)) checked @endif />
                    <label class="custom-control-label form-control-label"
                        for="new_client">{{ __('New Client') }}</label>
                </div>
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" name="client_check" value="exist" id="existing_client"
                        class="custom-control-input" @if (!empty($exist_client)) checked @endif />
                    <label class="custom-control-label form-control-label"
