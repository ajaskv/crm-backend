            ...
            @foreach ($lead->files as $file)
                @if (file_exists(storage_path('lead_files/' . $file->file_path)))
                    ...
                    myDropzone.emit("thumbnail", mockFile,
                        "{{ asset(Storage::url('lead_files/' . $file->file_path)) }}");
...
@section('action-button')
    <div class="all-button-box row d-flex justify-content-end">
        @can('edit lead')
            ...
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ URL::to('leads/' . $lead->id . '/edit') }}" data-size="lg" data-ajax-popup="true"
                    data-title="{{ __('Edit Lead') }}" class="btn btn-xs btn-white btn-icon-only width-auto"><i
        ...
        @can('convert lead to deal')
            @if (!empty($deal))
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                    <a href="@can('View Deal') @if ($deal->is_active) {{ route('deals.show', $deal->id) }} @else # @endif
    @else
    # @endcan" class="btn btn-xs btn-white btn-icon-only width-auto"><i class="fas fa-exchange-alt"></i>
                    {{ __('Already Converted To Deal') }}</a>
            </div>
        @else
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ URL::to('leads/' . $lead->id . '/show_convert') }}" data-size="lg"
                    data-ajax-popup="true" class="btn btn-xs btn-white btn-icon-only width-auto"><i
                        class="fas fa-exchange-alt"></i> {{ __('Convert To Deal') }}</a>
            </div>
        @endif
    @endcan
...
<div class="row">
    <div class="col-12 mb-3">
        <ul class="nav nav-tabs" id="myTab2" role="tablist">
            <li>
                <a class="nav-link-text" data-toggle="tab" href="#general" role="tab" aria-controls="home"
                    aria-selected="true">{{ __('General') }}</a>
            </li>
            @if (Auth::user()->type != 'client')
                <li>
                    <a class="nav-link-text" data-toggle="tab" href="#products" role="tab" aria-controls="contact"
                        aria-selected="false">{{ __('Products') }}</a>
                </li>
            @endif
            @if (Auth::user()->type != 'client')
                <li>
                    <a class="nav-link-text" data-toggle="tab" href="#sources" role="tab" aria-controls="contact"
                        aria-selected="false">{{ __('Sources') }}</a>
                </li>
            @endif
            @if (Auth::user()->type != 'client')
                <li>
                    <a class="nav-link-text" data-toggle="tab" href="#files" role="tab" aria-controls="contact"
                        aria-selected="false">{{ __('Files') }}</a>
                </li>
            @endif
            <li>
                <a class="nav-link-text" data-toggle="tab" href="#discussion" role="tab" aria-controls="contact"
                    aria-selected="false">{{ __('Discussion') }}</a>
            </li>
            @can('edit lead')
                <li>
                    <a class="nav-link-text" data-toggle="tab" href="#notes" role="tab" aria-controls="contact"
                        aria-selected="false">{{ __('Notes') }}</a>
                </li>
            @endcan
            @if (Auth::user()->type != 'client')
                <li>
                    <a class="nav-link-text" data-toggle="tab" href="#calls" role="tab" aria-controls="contact"
                        aria-selected="false">{{ __('Calls') }}</a>
                </li>
            @endif
            @if (Auth::user()->type != 'client')
                <li>
                    <a class="nav-link-text" data-toggle="tab" href="#emails" role="tab" aria-controls="contact"
        ...
        <div class="tab-content tab-bordered">
            <div class="tab-pane fade show active" id="general" role="tabpanel">
                <div class="card py-2 text-sm">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <ul class="nav nav-pills p-1">
                                <li class="nav-item">
                                    <a class="nav-link text-success" href="#">{{ __('Pipeline') }} <span
                                            class="badge badge-pill badge-success">{{ $lead->pipeline->name }}</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-warning" href="#">{{ __('Stage') }} <span
                                            class="badge badge-pill badge-warning">{{ $lead->stage->name }}</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="#">{{ __('Created') }} <span
                                            class="badge badge-pill badge-secondary">{{ \Auth::user()->dateFormat($lead->created_at) }}</span></a>
                                </li>
                                <li class="nav-item w-10">
                                    <div class="progress-wrapper pt-1">
                                        <span class="progress-tooltip"
                                            style="left: {{ $precentage }}%;">{{ $precentage }}%</span>
                                        <div class="progress" style="height: 3px;">
                                            <div class="progress-bar" role="progressbar"
                                                style="width: {{ $precentage }}%;"
                                                aria-valuenow="{{ $precentage }}" aria-valuemin="0"
                            ...
                            <ul class="nav nav-pills p-1">
                                <li class="nav-item">
                                    <a class="nav-link " href="#">{{ __('Name') }} <span
                                            class="badge badge-pill badge-secondary">{{ $lead->name }}</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="#">{{ __('Mail') }} <span
                                            class="badge badge-pill badge-secondary">{{ $lead->email }}</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="#">{{ __('Last Contacted') }} <span
                                            class="badge badge-pill badge-secondary">{{ $lastcontacted->created_at->diffForHumans() }}</span></a>
                                </li>
                                <li class="nav-item">
                                    @can('create lead call')
                                    <a href="#" class="btn btn-sm btn-white add-small"
                                        data-url="{{ route('leads.calls.create', $lead->id) }}" data-size="lg"
                                ...
                                <ul class="nav nav-pills p-1 float-right m-2">
                                    <li class="nav-item">
                                        @foreach ($labels as $label)
                                            <span
                                                class="badge badge-pill badge-{{ $label->color }}">{{ $label->name }}</span>
                                        @endforeach
                                    </li>
                                </ul>
                            ...
                            <div class="justify-content-between align-items-center d-flex">
                                ...
                                @can('edit lead')
                                    <a href="#" class="btn btn-sm btn-white float-right add-small"
                                        data-url="{{ route('leads.users.edit', $lead->id) }}" data-ajax-popup="true"
                                    ...
                                    <table class="table align-items-center mb-0">
                                        <tbody class="list">
                                            @foreach ($lead->users as $user)
                                                <tr>
                                                    <td>
                                                        <img @if ($user->avatar) src="{{ asset('/storage/uploads/avatar/' . $user->avatar) }}" @else src="{{ asset('assets/img/avatar/avatar-1.png') }}" @endif
                    ...
                    @if (Auth::user()->type != 'client')
                        <div class="col-xl-4 col-lg-4 col-sm-6 col-md-6">
                            <div class="justify-content-between align-items-center d-flex">
                                ...
                                @can('edit lead')
                                    <a href="#" class="btn btn-sm btn-white float-right add-small"
                                        data-url="{{ route('leads.products.edit', $lead->id) }}" data-ajax-popup="true"
                        ...
                        <div class="col-6">
                            ...
                            <div class="card">
                                <div class="card-body pb-0">
                                    <textarea class="form-control summernote-simple">{!! $lead->notes !!}</textarea>
                                </div>
                            </div>
                        </div>
                    @endcan
                                                    ...
                                                    @foreach ($lead->activities as $activity)
                                                        <div class="timeline-block">
                                                            ...
                                                            <div class="timeline-content">
                                                                ...
                                                                <a
                                                                    class="d-block h6 text-sm mb-0">{!! $activity->getLeadRemark() !!}</a>
                                                                <small><i
                ...
                <div class="card col-12">
                    @if (!empty($leadscustomFields) && count($lead->customField) > 0)
                        @foreach ($leadscustomFields as $field)
                            <div class="col text-md">
                                <small>
                                    <strong>{{ $field->name }} :</strong><br>
                                    {{ !empty($lead->customField) ? $lead->customField[$field->id] : '-' }}
                                    <br><br>
                                </small>
                            </div>
                        @endforeach
                    ...
                    <div class="row pt-2">
                        <div class="col-12">
                            <div class="justify-content-between align-items-center d-flex">
                                ...
                                @can('edit lead')
                                    <a href="#" class="btn btn-sm btn-white float-right add-small"
                                        data-url="{{ route('leads.sources.edit', $lead->id) }}" data-ajax-popup="true"
                ...
                <div class="tab-pane fade show" id="files" role="tabpanel">
                    <div class="row pt-2">
                        <div class="col-12">
                            ...
                            <div class="card mb-0">
                                <div class="card-body">
                                    <div class="col-md-12 dropzone top-5-scroll browse-file" id="dropzonewidget2">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row pt-2">
                    <div class="col-12">
                        <div class="justify-content-between align-items-center d-flex">
                            ...
                            <a href="#" class="btn btn-sm btn-white float-right add-small"
                                data-url="{{ route('leads.discussions.create', $lead->id) }}" data-ajax-popup="true"
                                        ...
                                        @foreach ($lead->discussions as $discussion)
                                            <li class="media mb-3">
                                                <img alt="image" class="mr-3 rounded-circle" width="50" height="50"
                                                    src="@if ($discussion->user->avatar) {{ asset('/storage/uploads/avatar/' . $discussion->user->avatar) }} @else {{ asset('assets/img/avatar/avatar-1.png') }} @endif">
                        ...
                        <div class="col-12">
                            <div class="justify-content-between align-items-center d-flex">
                                ...
                                @can('create lead email')
                                    <a href="#" class="btn btn-sm btn-white float-right add-small"
                                        data-url="{{ route('leads.emails.create', $lead->id) }}" data-size="lg"
