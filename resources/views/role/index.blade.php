    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('create role')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('roles.create') }}" data-size="xl" data-ajax-popup="true"
                    data-title="{{ __('Create New Role') }}" class="btn btn-xs btn-white btn-icon-only width-auto">
                                        ...
                                        <tr class="font-style">
                                            ...
                                            <td class="Permission">
                                                @for ($j = 0; $j < count($role->permissions()->pluck('name')); $j++)
                                                    <a href="#"
                                                        class="absent-btn">{{ $role->permissions()->pluck('name')[$j] }}</a>
                                                @endfor
                                            </td>
                                            <td class="Action">
                                                <span>
                                                    ...
                                                    @can('delete role')
                                                        <a href="#" class="delete-icon" data-toggle="tooltip"
                                                            ...
                                                            data-confirm-yes="document.getElementById('delete-form-{{ $role->id }}').submit();"><i
