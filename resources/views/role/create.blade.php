    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <ul class="nav nav-tabs my-3">
                <li class="nav-item">
                    <a class="active" data-toggle="tab" href="#staff" role="tab" aria-controls="home"
                        aria-selected="true">{{ __('Staff') }}</a>
                </li>
                <li class="nav-item">
                    <a class="" data-toggle="tab" href="#crm" role="tab" aria-controls="home"
                        aria-selected="true">{{ __('CRM') }}</a>
                </li>
                <li class="nav-item">
                    <a class="" data-toggle="tab" href="#project" role="tab" aria-controls="home"
                        aria-selected="true">{{ __('Project') }}</a>
                </li>
                <li class="nav-item">
                    <a class="" data-toggle="tab" href="#hrmpermission" role="tab" aria-controls="home"
                        aria-selected="true">{{ __('HRM') }}</a>
                </li>
                <li class="nav-item">
                    <a class="" data-toggle="tab" href="#account" role="tab" aria-controls="home"
                    ...
                    <div class="tab-content tab-bordered">
                                    ...
                                    @if (!empty($permissions))
                                        ...
                                        <table class="table table-striped mb-0" id="dataTable-1">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <input type="checkbox" class="align-middle custom_align_middle"
                                                            name="staff_checkall"
                                                            id="staff_checkall">{{ __('Select All') }}
                                                    </th>
                                                    <th>{{ __('Module') }} </th>
                                                ...
                                                @foreach ($modules as $module)
                                                    <tr>
                                                        <td><input type="checkbox"
                                                                class="align-middle ischeck staff_checkall"
                        ...
                        <div class="tab-pane fade show " id="crm" role="tabpanel">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    @if (!empty($permissions))
                                        <h6 class="my-3">{{ __('Assign CRM related Permission to Roles') }}
                                        </h6>
                                        <table class="table table-striped mb-0" id="dataTable-1">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($modules as $module)
                                                    <tr>
                                                        <td><input type="checkbox"
                                                                class="align-middle ischeck crm_checkall"
                        ...
                        <div class="tab-pane fade show " id="project" role="tabpanel">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    @if (!empty($permissions))
                                        <h6 class="my-3">
                                            {{ __('Assign Project related Permission to Roles') }}</h6>
                                        <table class="table table-striped mb-0" id="dataTable-1">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <input type="checkbox" class="align-middle custom_align_middle"
                                                            name="project_checkall"
                                                            id="project_checkall">{{ __('Select All') }}
                                                    </th>
                                                    <th>{{ __('Module') }} </th>
                                                    <th>{{ __('Permissions') }} </th>
                                                </tr>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($modules as $module)
                                                    <tr>
                                                        <td><input type="checkbox"
                                                                class="align-middle ischeck project_checkall"
                                                                data-id="{{ str_replace(' ', '', $module) }}"></td>
                                        ...
                                        <table class="table table-striped mb-0" id="dataTable-1">
                                            ...
                                            <tbody>
                                                @foreach ($modules as $module)
                                                    <tr>
                                                        <td><input type="checkbox"
                                                                class="align-middle ischeck hrm_checkall"
                                                                data-id="{{ str_replace(' ', '', $module) }}"></td>
                        ...
                        <div class="tab-pane fade show " id="account" role="tabpanel">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    @if (!empty($permissions))
                                        <h6 class="my-3">
                                            {{ __('Assign Account related Permission to Roles') }}</h6>
                                        <table class="table table-striped mb-0" id="dataTable-1">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <input type="checkbox" class="align-middle custom_align_middle"
                                                            name="account_checkall"
                                                            id="account_checkall">{{ __('Select All') }}
                                                    </th>
                                                    <th>{{ __('Module') }} </th>
                                                    <th>{{ __('Permissions') }} </th>
                                                </tr>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($modules as $module)
                                                    <tr>
                                                        <td><input type="checkbox" class="align-middle ischeck"
                                                                data-id="{{ str_replace(' ', '', $module) }}"></td>
