...
<body>
                ...
                success: function(data) {
                    if (data == "error") {
                        ...
                        $(".tooltip1").hover(function(e) {
                            ...
                            $(this).find(`#ul-${section_type}`).find('.tooltip1text').css("visibility",
                                "visible");
                            ...
                            key.forEach(function(val) {
                                ...
                                file_input.change(function() {
                                    ...
                                    var ext = url.substring(url.lastIndexOf('.') + 1)
                                        .toLowerCase();
                                    if (this.files && this.files[0] && (ext == "gif" || ext ==
                                            "png" || ext == "jpeg" || ext == "jpg")) {
                                        var reader = new FileReader();

                                        reader.onload = function(e) {
                                            $(`#setting-modal-section-${section_id}`).find(
                                                `#${val}`).find('img').attr('src', e
                                                .target.result);
                                ...
                                if (val == "button") {
                                    ...
                                    if (section_type == "section-1") {
                                        ...
                                        $(`#${section_type}`).find(`#${val}`).attr('href', content[val]
                                            .href);
                                    }
                                    ...
                                    $(`#setting-modal-section-${section_id}`).find(`#${val}`).find(
                                        ...
                                        var text_value = $(
                                                `#setting-modal-section-${section_id}`).find(
                                                `#${val}`).find(`input[name="button[text]"]`)
                                            .val();
                                    ...
                                    $(`#setting-modal-section-${section_id}`).find(`#${val}`).find(
                                        ...
                                        var href_value = $(
                                                `#setting-modal-section-${section_id}`).find(
                                                `#${val}`).find(`input[name="button[href]"]`)
                                            .val();
                                ...
                                if (val == "text") {
                                    ...
                                    menu_key.forEach(function(element) {
                                        ...
                                        $(`#${section_type}`).find(`#${element}`).html(content[
                                            val][element]);
                                        $(`#setting-modal-section-${section_id}`).find(
                                ...
                                if (val == "system") {
                                    ...
                                    $(`#setting-modal-section-${section_id}`).find("#accordion").html(
                                        new_tab_form);
                                    $(`#setting-modal-section-${section_id}`).find("#accordion").append(
                                        collpse_html);
                                }
                                if (val == "testimonials") {
                                ...
                                if (val == "footer") {
                                    ...
                                    footer.forEach(function(element) {
                                        if (element == "logo") {
                                            ...
                                            $(`#${section_type}`).find("#logo").find('#text')
                                                .html(text);
                                            ...
                                            $(`#setting-modal-section-${section_id}`).find(
                                                ...
                                                `{{ $image_path . '/${logo_img}' }}`);
                                            $(`#setting-modal-section-${section_id}`).find(
                                                `#logo`).find('#text').val(text1);

                                            $(`#setting-modal-section-${section_id}`).find(
                                                `#logo`).find(`#text`).keyup(function() {
                                                var text_value = '©' + new Date()
                                                    .getFullYear() + ' ' + $(this)
                                                    .val();
                                                $(`#${section_type}`).find("#logo")
                                                    .find('#text').html(text_value);
                                            });
                                            ...
                                            $(`#${section_type}`).find("#footer_bottom").find(
                                                '#text').html(text);
                                            var menu_html = "";
                                            ...
                                            $(`#setting-modal-section-${section_id}`).find(
                                                    `#footer_modal_footer_bottom`).find(`#text`)
                                                .keyup(function() {
                                                    var text_value = '©' + new Date()
                                                        .getFullYear() + ' ' + $(this)
                                                        .val();
                                                    $(`#${section_type}`).find(
                                                            "#footer_bottom").find('#text')
                                                        .html(text_value);
                                                });
                                        }
                                    });
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data == "error") {
                        ...
                        modalHide();
                        $(`.section_div_${id}`).load(`{{ url('/get_landing_page_section') }}/${view_name}`,
                            function() {
                                $(`.section_div_${id}`).find('.modal').attr('id',
                                    `setting-modal-section-${id}`);
                                $(`.section_div_${id}`).find('#section').attr('id', `section-${id}`);
                                $(`.section_div_${id}`).find('#ul-section').attr('id', `ul-section-${id}`);
                                $(`.section_div_${id}`).find('#setting_btn').attr('data-target',
                                    `#setting-modal-section-${id}`);
                ...
                @if ($value->content != '' && $value->content != null)
                    <div class="section_div_{{ $value->id }} tooltip1 ui-widget-content" id="{{ $value->id }}">
                        @if ($value->section_type == 'section-plan')
                            <script>
                                $('#{{ $value->id }}').load(
                                    `{{ url('/get_landing_page_section') }}/{{ $value->section_blade_file_name }}`,
                                    function() {
    ...
    <div class="modal right fade component_modal" id="component-modal" tabindex="-1" role="dialog"
        aria-labelledby="component-modal-label">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @if (count($get_section) > 0)
                        @foreach ($get_section as $key => $value)
                            @if ($value->content == '' || $value->content == null)
                                <img src="{{ asset('storage/uploads/Landing_page_component_image') }}/{{ $value->section_demo_image }}"
                                    onclick="set_section_page('{{ $value->id }}')"
                                    id="component_modal_{{ $value->id }}">
                            @endif
                        @endforeach
                    @endif
                </div>
    ...
    <script type="text/javascript">
        $("#sortablediv").sortable({
            ...
            stop: function(event, ui) {
                var idsInOrder = $("#sortablediv").sortable('toArray', {
                    attribute: 'id'
                });
                $.ajax({
                    type: 'POST',
