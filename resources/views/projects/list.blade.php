                        ...
                        @foreach ($projects as $key => $project)
                            <tr>
                                ...
                                <td>
                                    <span class="badge badge-dot mr-4">
                                        ...
                                        <span
                                            class="status">{{ __(\App\Models\Project::$project_status[$project->status]) }}</span>
                                    </span>
                                </td>
                                <td>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <span
                                        class="completion mr-2">{{ $project->project_progress()['percentage'] }}</span>
                                    <div>
                            ...
                            <td class="text-right w-15">
                                <div class="actions">
                                    <a href="#"
                                        ...
                                        data-title="{{ __('Invite Member') }}" class="action-item"
                                        data-toggle="tooltip" data-original-title="{{ __('Invite Member') }}">
