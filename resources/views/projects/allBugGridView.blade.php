                                                        ...
                                                        <a href="#" class="btn btn-sm mr-1 p-0 rounded-circle">
                                                            @foreach ($users as $user)
                                                                <img alt="image" data-toggle="tooltip"
                                                                    ...
                                                                    @if (!empty($user) && $user->avatar) src="{{ asset('/storage/uploads/avatar/' . !empty($user) ? $user->avatar : 'avatar-1.png') }}" @else src="{{ asset('assets/img/avatar/avatar-1.png') }}" @endif
