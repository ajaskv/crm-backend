<div class="card bg-none card-box">
    {{ Form::model($bug, ['route' => ['task.bug.update', $project_id, $bug->id], 'method' => 'POST']) }}
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {!! Form::select('priority', $priority, null, ['class' => 'form-control select2', 'required' => 'required']) !!}
        </div>
        <div class="form-group  col-md-6">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::select('assign_to', $users, null, ['class' => 'form-control select2', 'required' => 'required']) }}
        </div>
    </div>
    <div class="row">
