    ...
    <tr>
        ...
        <th>
            ...
            <div class="col-auto">
                ...
                <a href="#!" class="action-item text-danger trigger--fire-modal-1 trigger--fire-modal-11"
                    data-toggle="tooltip" data-original-title="{{ __('Delete') }}"
                    data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?"
                    data-confirm-yes="document.getElementById('project-user-delete-form-{{ $user->id }}').submit();">
