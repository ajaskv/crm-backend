    ...
    <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
        ...
        @can('view expense')
            <a href="{{ route('projects.expenses.index', $project->id) }}"
                class="btn btn-xs btn-white btn-icon-only width-auto">
                <span class="btn-inner--icon">{{ \Auth::user()->currencySymbol() }}<i
                        class="fa fa-money"></i>{{ __('Expense') }}</span>
            </a>
        @endcan
                    ...
                    <div class="progress-wrapper mb-3">
                        ...
                        <div class="progress mt-0 height-3">
                            <div class="progress-bar bg-info" role="progressbar"
                                ...
                                aria-valuemax="100" style="width: {{ $project_data['day_left']['percentage'] }}%;"></div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <span
                                class="h4 font-weight-bold mb-0 ">{{ \Auth::user()->priceFormat($project_data['expense']['total']) }}</span>
                        </div>
                        <div class="col-auto">
                            <div class="progress-circle progress-sm"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <span
                                class="text-sm text-muted">{{ __('Total Budget') . ' : ' . \Auth::user()->priceFormat($project->budget) }}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="progress-wrapper">
                        ...
                        <div class="progress mt-0 height-3">
                            <div class="progress-bar bg-warning" role="progressbar"
                                aria-valuenow="{{ $project_data['task_allocated_hrs']['percentage'] }}" aria-valuemin="0"
                                aria-valuemax="100"
                    ...
                    <div class="progress-wrapper">
                        ...
                        <div class="progress mt-0 height-3">
                            <div class="progress-bar bg-warning" role="progressbar"
                                ...
                                aria-valuemax="100" style="width: {{ $project_data['user_assigned']['percentage'] }}%;">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <li class="list-group-item">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    ...
                                    <div class="h6 mb-0">{{ Utility::getDateFormated($project->start_date) }}
                                    </div>
                                </div>
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        {{ Utility::getDateFormated($project->end_date) }}</div>
                                </div>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="mb-0">{{ __('Milestones') }} ({{ count($project->milestones) }})
                            </h6>
                        </div>
                        @can('create milestone')
                            <div class="text-right">
                                <a href="#" data-url="{{ route('project.milestone', $project->id) }}" data-ajax-popup="true"
                                    data-title="{{ __('Create New Milestone') }}"
                                    class="btn btn-sm btn-white float-right add-small">
                                    <span class="btn-inner--icon">
                                        <i class="fas fa-plus"></i>
                                        {{ __('Add') }}
                                    </span>
                                    ...
                                    <div class="media align-items-center">
                                        <div class="media-body">
                                            <h6 class="text-sm d-block text-limit mb-0">{{ $milestone->title }}
                                                <span
                                                    class="badge badge-pill badge-{{ \App\Models\Project::$status_color[$milestone->status] }}">{{ __(\App\Models\Project::$project_status[$milestone->status]) }}</span>
                                            </h6>
                                            <span
                                                class="d-block text-sm text-muted">{{ $milestone->tasks->count() . ' ' . __('Tasks') }}</span>
                                        </div>
                                        <div class="media-body text-right">
                                            <a href="#" class="action-item"
                                                data-url="{{ route('project.milestone.show', $milestone->id) }}"
                                                data-ajax-popup="true" data-title="{{ $milestone->title }}"
                                        ...
                                        <div class="px-3 py-3">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col ml-n2">
                                                    ...
                                                    <p class="card-text small text-muted">{{ $attachment->file_size }}
                                                    </p>
                                                </div>
                ...
                @foreach ($customFields as $field)
                    <div class="col text-md">
                        <small>
                            ...
                            {{ !empty($project->customField) ? $project->customField[$field->id] : '-' }}
                            <br><br>
                        </small>
                    </div>
                @endforeach
