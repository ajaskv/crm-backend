...
@section('action-button')
    <div class="all-button-box row d-flex justify-content-end">
        ...
        @can('manage bug report')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="{{ route('task.bug.kanban', $project->id) }}" class="btn btn-xs btn-white btn-icon-only width-auto"><i
                        class="fas fa-table"></i> {{ __('Bug Kanban') }} </a>
            </div>
        @endcan
        @can('manage project')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                                    ...
                                    <td class="Action" width="10%">
                                        @can('edit bug report')
                                            <a href="#" class="edit-icon"
                                                ...
                                                data-ajax-popup="true" data-title="{{ __('Edit Bug Report') }}">
