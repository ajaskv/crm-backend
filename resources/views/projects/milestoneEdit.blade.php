<div class="card bg-none card-box">
    {{ Form::model($milestone, ['route' => ['project.milestone.update', $milestone->id], 'method' => 'POST']) }}
    <div class="row">
        ...
        <div class="form-group  col-md-6">
            ...
            {!! Form::select('status', \App\Models\Project::$project_status, null, ['class' => 'form-control selectric select2', 'required' => 'required']) !!}
            @error('client')
