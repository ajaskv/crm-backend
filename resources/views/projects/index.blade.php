    ...
    <div class="col-xs-12 col-sm-12 col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
        ...
        <div class="btn-white rounded-pill d-inline-block mr-2">
            <div class="input-group input-group-sm input-group-merge input-group-flush">
                ...
                <input type="text" id="project_keyword" class="form-control form-control-flush"
        ...
        @endif
        <div class="dropdown">
            <a href="#" class="btn btn-xs btn-white btn-icon-only width-auto mr-2 action-item" role="button"
        ...
        @can('create project')
            <a href="#" class="btn btn-xs btn-white btn-icon-only width-auto ml-2" data-url="{{ route('projects.create') }}"
                data-ajax-popup="true" data-size="lg" data-title="{{ __('Create Project') }}">
