                                ...
                                <div data-v-f2a183a6="" class="d-header"
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-inner">
                                        ...
                                        <div data-v-f2a183a6="" class="d-header-50 d-right">
                                            ...
                                            @else
                                            <div data-v-f2a183a6="" class="d-title">{{ __('Local Purchase Order') }}</div>
                                            ...
                                            <table data-v-f2a183a6="" class="summary-table">
                                                <tbody data-v-f2a183a6="">
                                                    <tr>
                                                        <td>{{ __('Number') }}:</td>
                                                        @if (\Auth::user()->bill_ipo == 0)
                                                        <td>{{ $formated_bill_id = Utility::billNumberFormat($settings, $bill->bill_id) }}
                                                        @else
                                                        <td>{{ $formated_bill_id =Utility::ipoNumberFormat($settings, $bill->bill_id) }}
                                                        @endif
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>{{ __('Issue Date') }}:</td>
                                                        <td>{{ Utility::dateFormat($settings, $bill->bill_date) }}
                                                        </td>
                                                    </tr>
                                                    <!--<tr>-->
                                                    <!--    <td>{{ __('Due Date') }}:</td>-->
                                                    <!--    <td>{{ Utility::dateFormat($settings, $bill->due_date) }}-->
                                                    <!--    </td>-->
                                                    <!--</tr>-->
                                    ...
                                    <div data-v-f2a183a6="" class="d-bill-to">
                                        <div class="row">
                                            <div class="bill_to">
                                                ...
                                                <p>
                                                    ...
                                                    <!--{{ !empty($vendor->vender_id) ?"Vendor#:". $vendor->vender_id : '' }}<br>-->
                                                    {{ !empty($vendor->tax_number) ?"TRN#: ".$vendor->tax_number : '' }}
                                                </p>
                                            </div>
                                        ...
                                        <div data-v-f2a183a6="" class="d-table">
                                            <div data-v-f2a183a6="" class="d-table">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-tr"n
                                                    style="background: {{ $color }};color:{{ $font_color }}">
                                                    <div class="d-table-th w-1">{{ __('S.N') }}</div>
                                                    <div class="d-table-th w-8">{{ __('Item Description') }}</div>
                                                    <div class="d-table-th w-2">{{ __('Unit') }}</div>
                                                    ...
                                                    @endif
                                                    <!--<div class="d-table-th w-4">{{ __('Description') }}</div>-->
                                                ...
                                                <!--<div class="d-table-tr"-->
                                                <!--    style="border-bottom:1px solid {{ $color }};">-->
                                                <!--    <div class="d-table-td w-11">-->
                                                <!--        <pre data-v-f2a183a6="">{{ __('') }}</pre>-->
                                                <!--    </div>-->
                                                <!--    <div class="d-table-td w-2">-->
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary">
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            ...
                                                            <div data-v-f2a183a6="" class="d-table-value">
                                                                {{ Utility::priceFormat($settings, $bill->getSubTotal()) }}
                                                            </div>
                                                        </div>
                                                        @if ($bill->getTotalDiscount())
                                                            <div data-v-f2a183a6="" class="d-table-summary-item">
                                                                <div data-v-f2a183a6="" class="d-table-label">
                                                                    {{ __('Discount') }}:</div>
                                                                <div data-v-f2a183a6="" class="d-table-value">
                                                                    {{ Utility::priceFormat($settings, $bill->getTotalDiscount()) }}
                                                                </div>
                                                            </div>
                                                        @endif
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label">
                                                                {{ __('Total') }}:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">
                                                                {{ Utility::priceFormat($settings, $bill->getSubTotal() - $bill->getTotalDiscount() + $bill->getTotalTax()) }}
                                                            </div>
                                                        </div>
                                                        @if(Auth::user()->id != 6)
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label">
                                                                {{ __('Paid') }}:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">
                                                                {{ Utility::priceFormat($settings, $bill->getTotal() - $bill->getDue() - $bill->billTotalDebitNote()) }}
                                                            </div>
                                                        </div>
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label">
                                                                {{ __('Debit Note') }}:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">
                                                                {{ Utility::priceFormat($settings, $bill->billTotalDebitNote()) }}
                                                            </div>
                                                        </div>
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label">
                                                                {{ __('Due Amount') }}:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">
                                                                {{ Utility::priceFormat($settings, $bill->getDue()) }}
                                                            </div>
                                                        </div>
                                                        @endif
                                                    </div>
                                                </div>
                                                <img src="{{ asset('storage/uploads/seal/'.\Auth::user()->id.'company_seal.png')}}" style="height: 93px;object-fit: contain; float: right;" />
                                                <div data-v-f2a183a6="" class="d-header-50">
                                                    <p data-v-f2a183a6="" style="line-break:auto;width:62%;">
