                                        ...
                                        <table data-v-37eeda86="" class="summary-table">
                                            <tbody data-v-37eeda86="">
                                                ...
                                                <tr data-v-37eeda86="">
                                                    ...
                                                    <td data-v-37eeda86="" class="text-right">
                                                        {{ Utility::dateFormat($settings, $bill->due_date) }}</td>
                                                </tr>
                                            ...
                                            <div class="row">
                                                <div class="bill_to">
                                                    ...
                                                    <p>
                                                        ...
                                                        {{ !empty($vendor->vender_id) ? $vendor->vender_id : '' }}<br>
                                                        {{ !empty($vendor->tax_number) ? $vendor->tax_number : '' }}
                                                    </p>
                                                </div>
