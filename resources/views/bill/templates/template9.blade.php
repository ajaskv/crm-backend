                                ...
                                <div data-v-7d9d14b5="" class="d-inner"
                                    ...
                                    <div data-v-7d9d14b5="" class="row">
                                        <div data-v-7d9d14b5="" class="col-2">
                                            ...
                                            <h3 data-v-7d9d14b5="">
                                                {{ Utility::billNumberFormat($settings, $bill->bill_id) }}</h3>
                                            <p data-v-7d9d14b5="">
                                                {{ Utility::dateFormat($settings, $bill->bill_date) }}
                                            </p>
                                        </div>
                                        <div data-v-7d9d14b5="" class="col-2 text-right"><img data-v-7d9d14b5=""
                                                class="d-logo" src="{{ $img }}"
...
@endif
                                        ...
                                        <div data-v-7d9d14b5="" class="break-25"></div>
                                        <div data-v-7d9d14b5="">
                                            <h1 data-v-7d9d14b5="" style="color: {{ $color }};">
                                                {{ __('Thank you!') }}</h1>
                                        </div>
                                    </div>
                                </div>
