...
@push('script-page')
    ...
    <script>
        ...
        if ($(selector + " .repeater").length) {
            ...
            var $repeater = $(selector + ' .repeater').repeater({
                ...
                hide: function(deleteElement) {
                    ...
                    $('.subTotalVal').val(subTotal);
                    $('.totalAmountVal').val(subTotal);
                },
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (billItems != null) {
                                ...
                                $(el.parent().parent().find('.price')).val(item.product
                                    .purchase_price);
                            ...
                            if (item.taxes == 0) {
                                ...
                                for (var i = 0; i < item.taxes.length; i++) {
                                    taxes +=
                                        '<span class="badge badge-pill badge-primary mt-1 mr-1">' +
                            ...
                            if (billItems != null) {
                                var itemTaxPrice = parseFloat((totalItemTaxRate / 100) * (billItems
                                    .price * billItems.quantity));
                            } else {
                            ...
                            $('.totalTaxVal').val(totalItemTaxPrice);
                            $('.totalDiscountVal').val(totalItemDiscountPrice);
                            $('.totalAmountVal').val(parseFloat(subTotal) - parseFloat(
                                    totalItemDiscountPrice) + parseFloat(totalItemTaxPrice));
        ...
        $(document).on('keyup', '.quantity', function() {
            ...
            $('.totalAmount').val((parseFloat(subTotal) + parseFloat(totalItemTaxPrice)));
        ...
        $(document).on('keyup', '.price', function() {
            ...
            $('.subTotalVal').val(subTotal);
            $('.totalAmount').html((parseFloat(subTotal) + parseFloat(totalItemTaxPrice)).toFixed(2));
            $('.totalAmountVal').val((parseFloat(subTotal) + parseFloat(totalItemTaxPrice)));
        ...
        $(document).on('keyup', '.discount', function() {
            ...
            $('.totalAmountVal').val((parseFloat(subTotal) - parseFloat(totalItemDiscountPrice) + parseFloat(
                totalItemTaxPrice)));
        })
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            ...
                                            {{ Form::text('bill_date', null, ['class' => 'form-control datepicker', 'required' => 'required']) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            <span><i class="fas fa-calendar"></i></span>
                                            {{ Form::text('due_date', null, ['class' => 'form-control datepicker', 'required' => 'required']) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="custom-control custom-checkbox mt-4">
                                        <input class="custom-control-input" type="checkbox" name="discount_apply"
                                            id="discount_apply" {{ $bill->discount_apply == 1 ? 'checked' : '' }}>
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                            <div class="all-button-box">
                                <a href="#" data-repeater-create="" class="btn btn-xs btn-white btn-icon-only width-auto"
                        ...
                        <table class="table table-striped mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tbody class="ui-sortable" data-repeater-item>
                                <tr>
                                    ...
                                    <td width="25%">
                                        {{ Form::select('item', $product_services, null, ['class' => 'form-control select2 item', 'data-url' => route('bill.product')]) }}
                                    </td>
                                    <td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <input type="hidden" name="subTotal" class="subTotalVal">
                                    <td></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    ...
                                    <input type="hidden" name="totalDiscount" class="totalDiscountVal">
                                    <td></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    ...
                                    <input type="hidden" name="totalTax" class="totalTaxVal">
                                    <td></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    ...
                                    <input type="hidden" name="totalAmount" class="totalAmountVal">
                                    <td></td>
                                </tr>
                            </tfoot>
                        </table>
