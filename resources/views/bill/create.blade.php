                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            ...
                                            {{ Form::text('bill_date', '', ['class' => 'form-control datepicker', 'required' => 'required']) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tbody class="ui-sortable" data-repeater-item>
                                <tr>
                                    <td width="25%">
                                        {{ Form::select('item', $product_services, '', ['class' => 'form-control select2 item', 'data-url' => route('bill.product'), 'required' => 'required']) }}
                                    </td>
                                    <td>
