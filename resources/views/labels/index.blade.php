    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('create label')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('labels.create') }}" data-ajax-popup="true"
                    data-title="{{ __('Create Label') }}" class="btn btn-xs btn-white btn-icon-only width-auto"><i
                                    ...
                                    <ul class="list-group sortable">
                                        @foreach ($pipeline['labels'] as $label)
                                            <li class="list-group-item" data-id="{{ $label->id }}">
                                                <div class="badge badge-pill badge-{{ $label->color }}">
                                                    {{ $label->name }}
                                                </div>
                                                <span class="float-right">
                                                    ...
                                                    @can('delete label')
                                                        <a href="#" class="delete-icon" data-toggle="tooltip"
                                                            ...
                                                            data-confirm-yes="document.getElementById('delete-form-{{ $label->id }}').submit();"><i
