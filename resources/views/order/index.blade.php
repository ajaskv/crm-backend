                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($order->payment_status == 'succeeded')
                                                <span
                                                    class="badge badge-pill badge-success">{{ ucfirst($order->payment_status) }}</span>
                                            @else
                                                <span
                                                    class="badge badge-pill badge-danger">{{ ucfirst($order->payment_status) }}</span>
                                            @endif
                                        </td>
                                        ...
                                        <td class="Id">
                                            ...
                                            @else
                                                <a href="{{ $order->receipt }}" target="_blank"><i
