        ...
        @if (\Auth::user()->type == 'company')
            <div class="row">
                @if ($constant['taxes'] <= 0)
                    <div class="col-3">
                        <div class="alert alert-danger text-xs">
                            {{ __('Please add constant taxes. ') }}<a
                                href="{{ route('taxes.index') }}"><b>{{ __('click here') }}</b></a>
                        </div>
                    </div>
                @endif
                    ...
                    <div class="col-3">
                        <div class="alert alert-danger text-xs">
                            {{ __('Please add constant category. ') }}<a
                                href="{{ route('product-category.index') }}"><b>{{ __('click here') }}</b></a>
                        </div>
                    </div>
                @endif
                @if ($constant['units'] <= 0)
                    <div class="col-3">
                        <div class="alert alert-danger text-xs">
                            {{ __('Please add constant unit. ') }}<a
                                href="{{ route('product-unit.index') }}"><b>{{ __('click here') }}</b></a>
                        </div>
                    </div>
                @endif
                ...
                @if ($constant['bankAccount'] <= 0)
                    <div class="col-3">
                        <div class="alert alert-danger text-xs">
                            {{ __('Please create bank account. ') }}<a
                                href="{{ route('bank-account.index') }}"><b>{{ __('click here') }}</b></a>
                        </div>
                    </div>
                @endif
            </div>
                        ...
                        <table class="table align-items-center mb-0">
                            <tbody class="list">
                                <tr>
                                    ...
                                    <td>
                                        <h3 class="green-text">
                                            {{ \Auth::user()->priceFormat(\Auth::user()->todayIncome()) }}</h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <h3 class="red-text">
                                            {{ \Auth::user()->priceFormat(\Auth::user()->todayExpense()) }}</h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <h3 class="green-text">
                                            {{ \Auth::user()->priceFormat(\Auth::user()->incomeCurrentMonth()) }}</h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <h3 class="red-text">
                                            {{ \Auth::user()->priceFormat(\Auth::user()->expenseCurrentMonth()) }}</h3>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6">
                <div class="">
                    ...
                    <a href="{{ route('revenue.index') }}"
                        class="more-text history-text float-right">{{ __('View All') }}</a>
                </div>
                <div class="card bg-none dashboard-box-1">
                    <div class="table-responsive">
                        <table class="table align-items-center mb-0">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                ...
                <div class="card bg-none invo-tab dashboard-box-2">
                    <ul class="nav nav-tabs">
                        <li>
                            <a data-toggle="tab" href="#weekly_statistics"
                                class="active">{{ __('Weekly Statistics') }}</a>
                        </li>
                        <li class="annual-billing">
                            <a data-toggle="tab" href="#monthly_statistics"
                                class="">{{ __('Monthly Statistics') }}</a>
                        </li>
                    </ul>
                                ...
                                <table class="table align-items-center mb-0">
                                    <tbody class="list">
                                        <tr>
                                            ...
                                            <td>
                                                <h3 class="green-text">
                                                    {{ \Auth::user()->priceFormat($weeklyInvoice['invoiceTotal']) }}</h3>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <h3 class="red-text">
                                                    {{ \Auth::user()->priceFormat($weeklyInvoice['invoicePaid']) }}</h3>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <h3 class="green-text">
                                                    {{ \Auth::user()->priceFormat($weeklyInvoice['invoiceDue']) }}</h3>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table class="table align-items-center mb-0 ">
                                    <tbody class="list">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h3 class="green-text">
                                                    {{ \Auth::user()->priceFormat($monthlyInvoice['invoiceDue']) }}</h3>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                ...
                <div class="card bg-none invo-tab dashboard-box-2">
                    <ul class="nav nav-tabs">
                        <li>
                            <a data-toggle="tab" href="#bill_weekly_statistics"
                                class="active">{{ __('Weekly Statistics') }}</a>
                        </li>
                        <li class="annual-billing">
                            <a data-toggle="tab" href="#bill_monthly_statistics"
                                class="">{{ __('Monthly Statistics') }}</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                                ...
                                <table class="table align-items-center mb-0">
                                    <tbody class="list">
                                        <tr>
                                            ...
                                            <td>
                                                <h3 class="green-text">
                                                    {{ \Auth::user()->priceFormat($weeklyBill['billTotal']) }}</h3>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <h3 class="red-text">
                                                    {{ \Auth::user()->priceFormat($weeklyBill['billPaid']) }}</h3>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <h3 class="green-text">
                                                    {{ \Auth::user()->priceFormat($weeklyBill['billDue']) }}</h3>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table class="table align-items-center mb-0">
                                    <tbody class="list">
                                        <tr>
                                            ...
                                            <td>
                                                <h3 class="green-text">
                                                    {{ \Auth::user()->priceFormat($monthlyBill['billTotal']) }}</h3>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <h3 class="red-text">
                                                    {{ \Auth::user()->priceFormat($monthlyBill['billPaid']) }}</h3>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <h3 class="green-text">
                                                    {{ \Auth::user()->priceFormat($monthlyBill['billDue']) }}</h3>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 col-sm-6">
                                    <div class="p-4">
                                        ...
                                        <h5 class="report-text mb-0">{{ __(\App\Models\Goal::$goalType[$goal->type]) }}
                                        </h5>
                                    </div>
                                </div>
                                    ...
                                    <div class="progress-wrapper pt-0">
                                        <div class="progress progress-xs mb-0 w-100">
                                            <div class="progress-bar bg-warning" role="progressbar"
                                                aria-valuenow="{{ number_format($goal->target($goal->type, $goal->from, $goal->to, $goal->amount)['percentage'], Utility::getValByName('decimal_number'), '.', '') }}"
