                    ...
                    <div class="card-body">
                        @foreach ($home_data['project_status'] as $status => $val)
                            <div class="row align-items-center mb-4">
                                ...
                                <div class="col">
                                    <span
                                        class="d-block h6 mb-0">{{ __(\App\Models\Project::$project_status[$status]) }}</span>
                                </div>
                            </div>
                        @endforeach
                                                ...
                                                <div class="flex-fill pl-3 text-limit">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-3 text-right">
                                                            <span
                                                                class="badge badge-xs badge-{{ \Auth::user()->checkProject($due_project->id) == 'Owner' ? 'success' : 'warning' }}">{{ \Auth::user()->checkProject($due_project->id) }}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div>
                                                            <span
                                                                class="font-weight-bold text-{{ \App\Models\Project::$status_color[$due_project->status] }}">{{ \App\Models\Project::$project_status[$due_project->status] }}</span>
                                                        </div>
                                                        <div>
                        ...
                        <table class="table mb-0 align-items-center">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="sort" data-sort="completion">{{ __('Completion') }}
                                    </th>
                                </tr>
                            </thead>
                            <tbody class="list">
                                            ...
                                            <div class="media align-items-center">
                                                <div class="media-body ml-4">
                                                    <a href="{{ route('projects.tasks.index', $due_task->project->id) }}"
                                                        class="name mb-0 h6 text-sm">{{ $due_task->name }}</a>
                                                </div>
                                            </div>
                                        </th>
                                    ...
                                    <div class="card border shadow-none">
                                        <div class="px-3 py-2 row align-items-center">
                                            ...
                                            <div class="col-2 card-meta d-inline-flex align-items-center">
                                                <button class="btn btn-sm btn-white float-right add-small" type="submit"
                                                    id="todo_submit">
                                                    <i class="fas fa-plus "></i>
                                                </button>
                                            </div>
    ...
    <script>
            ...
            if (title != '') {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        show_toastr('{{ __('Success') }}', '{{ __('Todo Added Successfully!') }}',
                            'success');
        ...
        $(document).on("change", "#todolist input[type=checkbox]", function() {
            $.ajax({
                ...
                dataType: 'JSON',
                success: function(data) {
                    show_toastr('{{ __('Success') }}', '{{ __('Todo Updated Successfully!') }}',
                        'success');
                },
                error: function(data) {
                    data = data.responseJSON;
        ...
        $(document).on('click', '.d-todo', function() {
            ...
            $.ajax({
                ...
                dataType: 'JSON',
                success: function(data) {
                    show_toastr('{{ __('Success') }}', '{{ __('Todo Deleted Successfully!') }}',
                        'success');
