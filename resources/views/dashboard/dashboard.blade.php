            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                <div class="card card-box">
                    ...
                    <div class="user-text">
                        ...
                        <h5>{{ __('Active Training ') }} : <span class="text-dark text-sm"> {{ $onGoingTraining }}
                            </span>
                        </h5>
                        <h5>{{ __('Done Training ') }} : <span class="text-dark text-sm"> {{ $doneTraining }} </span>
                        </h5>
                    </div>
                </div>
                <img src="{{ asset('assets/img/dot-icon.png') }}" alt="" class="dotted-icon">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                    <div class="card card-box">
                        ...
                        <div class="user-text">
                            ...
                            <h5>{{ __('Inactive Job') }} : <span class="text-dark text-sm">{{ $inActiveJOb }}</span>
                            </h5>
                        </div>
                    </div>
                    <img src="{{ asset('assets/img/dot-icon.png') }}" alt="" class="dotted-icon">
                    ...
                    <div class="card-header ">
                        <div class="row">
                            ...
                            <div class="col-xl-5 col-lg-4 col-md-5 col-sm-6 text-center">
                                <h5 class="fullcalendar-title h4 d-inline-block font-weight-600 mb-0">
                                    {{ __('Calendar') }}
                                </h5>
                            </div>
                            ...
                            @can('create event')
                                <a href="#" data-url="{{ route('event.create') }}" class="btn btn-sm btn-neutral"
                                    data-ajax-popup="true" data-title="{{ __('Create New Event') }}">
