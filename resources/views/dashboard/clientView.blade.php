            ...
            <div class="card card-box height-95">
                ...
                <div class="number-icon w-100">
                    ...
                    <div class="border-progress">
                        <div class="border-inner-progress {{ $label1 }}"
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="card card-box height-95">
                ...
                <div class="number-icon w-100">
                    ...
                    <div class="border-progress">
                        <div class="border-inner-progress {{ $label }}"
                            style="width:{{ $project['project_task_percentage'] }}%"></div>
                    </div>
                </div>
                <img src="{{ asset('assets/img/dot-icon.png') }}" alt="" class="dotted-icon-c">
            </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="card card-box height-95">
                ...
                <div class="number-icon w-100">
                    ...
                    <div class="border-progress">
                        <div class="border-inner-progress {{ $label2 }}"
                            style="width:{{ $project['project_bug_percentage'] }}%"></div>
                    </div>
                </div>
                <img src="{{ asset('assets/img/dot-icon.png') }}" alt="" class="dotted-icon-c">
            </div>
                        ...
                        <tbody class="list">
                            @forelse($project['projects'] as $project)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('projects.show', $project->id) }}" class="edit-icon"><i
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
        ...
        <div class="card bg-none py-4 min-410 mx-410">
            <div class="chart">
                ...
                <canvas id="chart-doughnut" class="chart-canvas chartjs-render-monitor" width="734" height="350"
                    style="display: block; width: 734px; height: 350px;"></canvas>
            </div>
