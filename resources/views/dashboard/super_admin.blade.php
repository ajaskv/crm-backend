        ...
        e.length && e.each(function() {
            ! function(e) {
                var t = {
                    ...
                    n = e.data().height,
                    o = e.data().type;
                t.colors = [PurposeStyle.colors.theme[a]], t.markers.colors = [PurposeStyle.colors.theme[a]], t
                    .chart.height = n || 350, t.chart.type = o || "line";
    ...
    <div class="row">
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="card card-box">
                ...
                <div class="user-text">
                    <h5>{{ __('PAID USERS') }} : <span class="text-dark text-sm">{{ $user['total_paid_user'] }}</span>
                    </h5>
                </div>
            </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="card card-box">
                ...
                <div class="user-text">
                    <h5>{{ __('Total Order Amount') }} : <span
                            class="text-dark text-sm">{{ (!empty(env('CURRENCY_SYMBOL')) ? env('CURRENCY_SYMBOL') : '$') . $user['total_orders_price'] }}</span>
                    </h5>
                </div>
            </div>
            <img src="{{ asset('assets/img/dot-icon.png') }}" alt="" class="dotted-icon">
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="card card-box">
                ...
                <div class="user-text">
                    <h5>{{ __('Most Purchase Plan') }} : <span
                            class="text-dark text-sm">{{ $user['most_purchese_plan'] }}</span></h5>
                </div>
            </div>
            <img src="{{ asset('assets/img/dot-icon.png') }}" alt="" class="dotted-icon">
        </div>
