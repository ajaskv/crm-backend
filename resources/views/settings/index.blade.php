                        ...
                        <ul class="nav nav-tabs my-4">
                            ...
                            <li class="annual-billing">
                                <a data-toggle="tab" href="#pusher-settings"
                                    class="">{{ __('Pusher Setting') }} </a>
                            </li>
                            <li class="annual-billing">
                                <a data-toggle="tab" href="#recaptcha-settings"
                                    class="">{{ __('ReCaptcha Setting') }} </a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="tab-content">
                            ...
                            <div class="col-lg-3 col-sm-6 col-md-6">
                                ...
                                <div class="card setting-card">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input" name="SITE_RTL"
                                                        id="SITE_RTL" {{ $SITE_RTL == 'on' ? 'checked="checked"' : '' }}>
                                                    <label class="custom-control-label form-control-label"
                                                        for="SITE_RTL"></label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="w-50 float-left">
                                            {{ Form::label('signup', __('Enable SignUp'), ['class' => 'form-control-label']) }}
                                            <div class="">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input" name="enable_signup"
                                                        id="enable_signup"
                                                        {{ $settings['enable_signup'] == 'on' ? 'checked="checked"' : '' }}>
                                                    <label class="custom-control-label form-control-label"
                                                        for="enable_signup"></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div id="pusher-settings" class="tab-pane">
                        ...
                        <div class="card bg-none company-setting">
                            ...
                            <div class="col-lg-12 text-right">
                                {{ Form::submit(__('Save Change'), ['class' => 'btn-submit text-white']) }}
                            </div>
                        </div>
                        {{ Form::close() }}
                    </div>
                                ...
                                <form method="POST" action="{{ route('recaptcha.settings.store') }}"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" name="recaptcha_module"
