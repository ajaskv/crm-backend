                ...
                <div class="col-lg-12 our-system">
                    <div class="row">
                        <ul class="nav nav-tabs my-4">
                            <li>
                                <a data-toggle="tab" href="#business-setting"
                                    class="active">{{ __('Business Setting') }}</a>
                            </li>
                            <li class="annual-billing">
                                <a data-toggle="tab" href="#system-setting"
                                    class="">{{ __('System Setting') }}
                                </a>
                            </li>
                            <li class="annual-billing">
                                <a data-toggle="tab" href="#company-setting"
                                    class="">{{ __('Company Setting') }} </a>
                            </li>
                            <li class="annual-billing">
                                <a data-toggle="tab" href="#payment-setting"
                                    class="">{{ __('Payment Setting') }} </a>
                            </li>
                            <li class="annual-billing">
                                <a data-toggle="tab" href="#zoom-meeting-setting"
                                    class="">{{ __('Zoom-Meeting Setting') }} </a>
                            </li>
                            <li class="annual-billing">
                                <a data-toggle="tab" href="#slack-setting"
                                    class="">{{ __('Slack Setting') }}</a>
                            </li>

                            <li class="annual-billing">
                                <a data-toggle="tab" href="#telegram-setting"
                                    class="">{{ __('Telegram Setting') }}</a>
                            </li>
                            <li class="annual-billing">
                                <a data-toggle="tab" href="#twilio-setting"
                                    class="">{{ __('Twilio Setting') }} </a>
                            </li>
                            <li class="annual-billing">
                                <a data-toggle="tab" href="#mail-setting" class="">{{ __('Mail Setting') }}
                                </a>
                            </li>
                            <li class="annual-billing">
                                <a data-toggle="tab" href="#mailchimp-setting"
                                    class="">{{ __('MailChimp Setting') }} </a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="tab-content">
                    ...
                    <div id="system-setting" class="tab-pane">
                        <div class="col-md-12">
                            ...
                            <div class="card bg-none">
                                {{ Form::model($settings, ['route' => 'system.settings', 'method' => 'post','enctype'=>'multipart/form-data'])  }}
                                <div class="card-body pd-0">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="form-control-label mb-0">{{ __('Tracking Interval') }}</label>
                                            <br>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            {{ Form::textarea('footer_notes', null, ['class' => 'form-control summernote-simple', 'rows' => '3']) }}
                                            @error('footer_notes')
                                        ...
                                        <div class="form-group col-md-6">
                                            <div class="card setting-card setting-logo-box">
                                            {{ Form::label('footer_notes', __('Company seal'), ['class' => 'form-control-label ']) }}

                                                <div class="logo-content">
                                                    <img src="{{ asset('storage/uploads/seal/'.\Auth::user()->id.'company_seal.png')}}" class="small-logo" alt="">
                                                </div>
                                                <div class="choose-file mt-5">
                                                    <label for="company_seal">
                                                        <div>Choose file here</div>
                                                        <input type="file" class="form-control" name="company_seal" id="company_seal" data-filename="edit-company-favicon">
                                                    </label>
                                                    <p class="edit-company-favicon"></p>
                                                </div>
                                            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card bg-none company-setting">
                                ...
                                <div id="accordion-2" class="accordion accordion-spaced">
                                    ...
                                    <!-- PaymentWall -->
                                    <div class="card">
                                        <div class="card-header py-4" id="heading-2-11" data-toggle="collapse"
                                            role="button" data-target="#collapse-2-11" aria-expanded="false"
                    ...
                    <div id="zoom-meeting-setting" class="tab-pane">
                        <div class="col-md-12">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-md-6 col-sm-6 mb-3 mb-md-0">
                                    <h4 class="h4 font-weight-400 float-left pb-2">{{ __('Zoom-Meeting Setting') }}
                                    </h4>
                                </div>
                            </div>
                            <div class="card bg-none">
                                ...
                                <div class="card-body pd-0">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label class="form-control-label mb-0">{{ __('Zoom API Key') }}</label>
                                            <br>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="form-control-label mb-0">{{ __('Zoom API Secret') }}</label>
                                            <br>
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            ...
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('lead_notification', '1', isset($settings['lead_notification']) && $settings['lead_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'lead_notification']) }}
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('deal_notification', '1', isset($settings['deal_notification']) && $settings['deal_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'deal_notification']) }}
                                ...
                                <div class="col-md-4">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            ...
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('leadtodeal_notification', '1', isset($settings['leadtodeal_notification']) && $settings['leadtodeal_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'leadtodeal_notification']) }}
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('contract_notification', '1', isset($settings['contract_notification']) && $settings['contract_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'contract_notification']) }}
                                ...
                                <div class="col-md-4">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            ...
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('project_notification', '1', isset($settings['project_notification']) && $settings['project_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'project_notification']) }}
                                ...
                                <div class="col-md-4">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            ...
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('taskmove_notification', '1', isset($settings['taskmove_notification']) && $settings['taskmove_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'taskmove_notification']) }}
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('taskcomment_notification', '1', isset($settings['taskcomment_notification']) && $settings['taskcomment_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'taskcomment_notification']) }}
                                ...
                                <div class="col-md-4">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            ...
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('payslip_notification', '1', isset($settings['payslip_notification']) && $settings['payslip_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'payslip_notification']) }}
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('award_notification', '1', isset($settings['award_notification']) && $settings['award_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'award_notification']) }}
                                ...
                                <div class="col-md-4">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            ...
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('support_notification', '1', isset($settings['support_notification']) && $settings['support_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'support_notification']) }}
                                ...
                                <div class="col-md-4">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('policy_notification', '1', isset($settings['policy_notification']) && $settings['policy_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'policy_notification']) }}
                                ...
                                <div class="col-md-4">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            ...
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('budget_notification', '1', isset($settings['budget_notification']) && $settings['budget_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'budget_notification']) }}
                            ...
                            <div class="row">
                                ...
                                <div class="card-body pd-0">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="form-control-label mb-0">{{ __('Telegram ChatID') }}</label>
                                            <br>
                                ...
                                <div class="col-md-4">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <span>{{ __('Lead create') }}</span>
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('telegram_lead_notification', '1', isset($settings['telegram_lead_notification']) && $settings['telegram_lead_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_lead_notification']) }}
                                                <label class="custom-control-label"
                                        ...
                                        <li class="list-group-item">
                                            <span>{{ __('Deal create') }}</span>
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('telegram_deal_notification', '1', isset($settings['telegram_deal_notification']) && $settings['telegram_deal_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_deal_notification']) }}
                                                <label class="custom-control-label"
                                ...
                                <div class="col-md-4">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <span>{{ __('Lead To Deal convert') }}</span>
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('telegram_leadtodeal_notification', '1', isset($settings['telegram_leadtodeal_notification']) && $settings['telegram_leadtodeal_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_leadtodeal_notification']) }}
                                                <label class="custom-control-label"
                                        ...
                                        <li class="list-group-item">
                                            <span>{{ __('Contract create') }}</span>
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('telegram_contract_notification', '1', isset($settings['telegram_contract_notification']) && $settings['telegram_contract_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_contract_notification']) }}
                                                <label class="custom-control-label"
                                ...
                                <div class="col-md-4">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <span>{{ __('Project create') }}</span>
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('telegram_project_notification', '1', isset($settings['telegram_project_notification']) && $settings['telegram_project_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_project_notification']) }}
                                                <label class="custom-control-label"
                                ...
                                <div class="col-md-4">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <span>{{ __('Task Move create') }}</span>
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('telegram_taskmove_notification', '1', isset($settings['telegram_taskmove_notification']) && $settings['telegram_taskmove_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_taskmove_notification']) }}
                                                <label class="custom-control-label"
                                        ...
                                        <li class="list-group-item">
                                            <span>{{ __('Task Comment') }}</span>
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('telegram_taskcomment_notification', '1', isset($settings['telegram_taskcomment_notification']) && $settings['telegram_taskcomment_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_taskcomment_notification']) }}
                                                <label class="custom-control-label"
                                ...
                                <div class="col-md-4">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <span>{{ __('Monthly Payslip Generate') }}</span>
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('telegram_payslip_notification', '1', isset($settings['telegram_payslip_notification']) && $settings['telegram_payslip_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_payslip_notification']) }}
                                                <label class="custom-control-label"
                                ...
                                <div class="col-md-4">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <span>{{ __('Support create') }}</span>
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('telegram_support_notification', '1', isset($settings['telegram_support_notification']) && $settings['telegram_support_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_support_notification']) }}
                                                <label class="custom-control-label"
                                ...
                                <div class="col-md-4">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item">
                                            <span>{{ __('Company Policy create') }}</span>
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('telegram_policy_notification', '1', isset($settings['telegram_policy_notification']) && $settings['telegram_policy_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_policy_notification']) }}
                                                <label class="custom-control-label"
                                ...
                                <div class="col-md-4">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <span>{{ __('Invoice create') }}</span>
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('telegram_invoice_notification', '1', isset($settings['telegram_invoice_notification']) && $settings['telegram_invoice_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_invoice_notification']) }}
                                                <label class="custom-control-label"
                                        ...
                                        <li class="list-group-item">
                                            <span>{{ __('Revenue create') }}</span>
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('telegram_revenue_notification', '1', isset($settings['telegram_revenue_notification']) && $settings['telegram_revenue_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_revenue_notification']) }}
                                                <label class="custom-control-label"
                                ...
                                <div class="col-md-4">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <span>{{ __('Bill create') }}</span>
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('telegram_bill_notification', '1', isset($settings['telegram_bill_notification']) && $settings['telegram_bill_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_bill_notification']) }}
                                                <label class="custom-control-label"
                                        ...
                                        <li class="list-group-item">
                                            <span>{{ __('Payment create') }}</span>
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('telegram_payment_notification', '1', isset($settings['telegram_payment_notification']) && $settings['telegram_payment_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_payment_notification']) }}
                                                <label class="custom-control-label"
                                ...
                                <div class="col-md-4">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <span>{{ __('Budget create') }}</span>
                                            <div class="custom-control custom-switch float-right">
                                                {{ Form::checkbox('telegram_budget_notification', '1', isset($settings['telegram_budget_notification']) && $settings['telegram_budget_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'telegram_budget_notification']) }}
                                                <label class="custom-control-label"
                                        ...
                                        <div class="col-md-6">
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    ...
                                                    <div class="custom-control custom-switch float-right">
                                                        {{ Form::checkbox('twilio_customer_notification', '1', isset($settings['twilio_customer_notification']) && $settings['twilio_customer_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'twilio_customer_notification']) }}
                                                        <label class="custom-control-label"
                                                ...
                                                <li class="list-group-item">
                                                    ...
                                                    <div class="custom-control custom-switch float-right">
                                                        {{ Form::checkbox('twilio_vender_notification', '1', isset($settings['twilio_vender_notification']) && $settings['twilio_vender_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'twilio_vender_notification']) }}
                                                        <label class="custom-control-label"
                                        ...
                                        <div class="col-md-6">
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    <span>{{ __('Invoice Create') }}</span>
                                                    <div class="custom-control custom-switch float-right">
                                                        {{ Form::checkbox('twilio_invoice_notification', '1', isset($settings['twilio_invoice_notification']) && $settings['twilio_invoice_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'twilio_invoice_notification']) }}
                                                        <label class="custom-control-label"
                                                ...
                                                <li class="list-group-item">
                                                    <span>{{ __('Revenue create') }}</span>
                                                    <div class="custom-control custom-switch float-right">
                                                        {{ Form::checkbox('twilio_revenue_notification', '1', isset($settings['twilio_revenue_notification']) && $settings['twilio_revenue_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'twilio_revenue_notification']) }}
                                                        <label class="custom-control-label"
                                        ...
                                        <div class="col-md-6">
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    <span>{{ __('Bill Create') }}</span>
                                                    <div class="custom-control custom-switch float-right">
                                                        {{ Form::checkbox('twilio_bill_notification', '1', isset($settings['twilio_bill_notification']) && $settings['twilio_bill_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'twilio_bill_notification']) }}
                                                        <label class="custom-control-label"
                                                ...
                                                <li class="list-group-item">
                                                    ...
                                                    <div class="custom-control custom-switch float-right">
                                                        {{ Form::checkbox('twilio_proposal_notification', '1', isset($settings['twilio_proposal_notification']) && $settings['twilio_proposal_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'twilio_proposal_notification']) }}
                                                        <label class="custom-control-label"
                                        ...
                                        <div class="col-md-6">
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    <span>{{ __('Payment Create') }}</span>
                                                    <div class="custom-control custom-switch float-right">
                                                        {{ Form::checkbox('twilio_payment_notification', '1', isset($settings['twilio_payment_notification']) && $settings['twilio_payment_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'twilio_payment_notification']) }}
                                                        <label class="custom-control-label"
                                                ...
                                                <li class="list-group-item">
                                                    ...
                                                    <div class="custom-control custom-switch float-right">
                                                        {{ Form::checkbox('twilio_reminder_notification', '1', isset($settings['twilio_reminder_notification']) && $settings['twilio_reminder_notification'] == '1' ? 'checked' : '', ['class' => 'custom-control-input', 'id' => 'twilio_reminder_notification']) }}
                                                        <label class="custom-control-label"
                    ...
                    <div id="mail-setting" class="tab-pane">
                        <div class="col-md-12">
                            ...
                            <div class="card bg-none company-setting">
                                {{ Form::open(['route' => 'mail.settings', 'method' => 'post']) }}
                                <div class="row">
                                    <div class="col-lg-3 col-md-6 col-sm-6 form-group">
                                        {{ Form::label('mail_driver', __('Mail Driver'), ['class' => 'form-control-label']) }}
                                        {{ Form::text('mail_driver', isset($mail['mail_driver']) ? $mail['mail_driver'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Mail Driver')]) }}
                                        @error('mail_driver')
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 form-group">
                                        ...
                                        {{ Form::text('mail_host', isset($mail['mail_host']) ? $mail['mail_host'] : '', ['class' => 'form-control ', 'placeholder' => __('Enter Mail Host')]) }}
                                        @error('mail_host')
                                            <span class="invalid-mail_driver" role="alert">
                                                <strong class="text-danger">{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 form-group">
                                        ...
                                        {{ Form::text('mail_port', isset($mail['mail_port']) ? $mail['mail_port'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Mail Port')]) }}
                                        @error('mail_port')
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 form-group">
                                        ...
                                        {{ Form::text('mail_username', isset($mail['mail_username']) ? $mail['mail_username'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Mail Username')]) }}
                                        @error('mail_username')
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 form-group">
                                        ...
                                        {{ Form::text('mail_password', isset($mail['mail_password']) ? $mail['mail_password'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Mail Password')]) }}
                                        @error('mail_password')
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 form-group">
                                        ...
                                        {{ Form::text('mail_encryption', isset($mail['mail_encryption']) ? $mail['mail_encryption'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Mail Encryption')]) }}
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 form-group">
                                        ...
                                        {{ Form::text('mail_from_address', isset($mail['mail_from_address']) ? $mail['mail_from_address'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Mail From Address')]) }}
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 form-group">
                                        ...
                                        {{ Form::text('mail_from_name', isset($mail['mail_from_name']) ? $mail['mail_from_name'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Mail Name')]) }}
                    ...
                    <div id="mailchimp-setting" class="tab-pane">
                        <div class="col-md-12">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-md-6 col-sm-6 mb-3 mb-md-0">
                                    <h4 class="h4 font-weight-400 float-left pb-2">{{ __('MailChimp settings') }}</h4>
                                </div>
                            </div>
                            <div class="card bg-none company-setting">
                                {{ Form::open(['route' => 'mailchimp.settings', 'method' => 'post']) }}
                                <div class="row">
                                    <div class="col-lg-3 col-md-6 col-sm-6 form-group">
                                        {{ Form::label('mailchimp_api_key', __('MailChimp API KEY'), ['class' => 'form-control-label']) }}
                                        {{ Form::text('mailchimp_api_key', isset($mail['mailchimp_api_key']) ? $mail['mailchimp_api_key'] : '', ['class' => 'form-control', 'placeholder' => __('Mailchimp API Key')]) }}
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 form-group">
                                        {{ Form::label('mailchimp_list_id', __('Mailchimp List ID'), ['class' => 'form-control-label']) }}
                                        {{ Form::text('mailchimp_list_id', isset($mail['mailchimp_list_id']) ? $mail['mailchimp_list_id'] : '', ['class' => 'form-control ', 'placeholder' => __('MailChimp Listid')]) }}
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 form-group">
                                        {{ Form::label('mailchimp_from_email', __('MailChimp From Email'), ['class' => 'form-control-label']) }}
                                        {{ Form::email('mailchimp_from_email', isset($mail['mailchimp_from_email']) ? $mail['mailchimp_from_email'] : '', ['class' => 'form-control', 'placeholder' => __('Enter From Mail')]) }}
                                        @error('mailchimp_from_email')
                                            <span class="invalid-mail_port" role="alert">
                                                <strong class="text-danger">{{ $message }}</strong>
                                            </span>
                                        @enderror
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 form-group">
                                        {{ Form::label('mailchimp_from_name', __('Mailchimp from name'), ['class' => 'form-control-label']) }}
                                        {{ Form::text('mailchimp_from_name', isset($mail['mailchimp_from_name']) ? $mail['mailchimp_from_name'] : '', ['class' => 'form-control', 'placeholder' => __('MailChimp from name')]) }}
                                        @error('mailchimp_from_name')
                                            <span class="invalid-mail_username" role="alert">
                                                <strong class="text-danger">{{ $message }}</strong>
                                            </span>
                                        @enderror
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 form-group">
                                        {{ Form::label('mailchimp_to_name', __('MailChimp List Name'), ['class' => 'form-control-label']) }}
                                        {{ Form::text('mailchimp_to_name', isset($mail['mailchimp_to_name']) ? $mail['mailchimp_to_name'] : '', ['class' => 'form-control', 'placeholder' => __('MailChimp To List Name')]) }}
                                        @error('mailchimp_to_name')
                                            <span class="invalid-mail_password" role="alert">
                                                <strong class="text-danger">{{ $message }}</strong>
                                            </span>
                                        @enderror
