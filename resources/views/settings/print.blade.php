                    ...
                    <div id="proposal-template-setting" class="tab-pane in active">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-md-6 col-sm-6 mb-3 mb-md-0">
                                <h4 class="h4 font-weight-400 float-left pb-2">
                                    @if (\Auth::user()->pro_quo == 0)
                                    {{ __('Proposal Print Settings') }}

                                    @else
                                    {{ __('Quotation Print Settings') }}
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-2">
                                            ...
                                            @if (\Auth::user()->pro_quo == 0)
                                            <a href="{{ route('setview.setting',["pro_quo",1]) }}" class="btn btn-sm btn-primary rounded-pill">
                                                {{ __('Switch To Quotation') }}
                                            </a>
                                            @else
                                            <a href="{{ route('setview.setting',["pro_quo",0]) }}" class="btn btn-sm btn-primary rounded-pill">
                                                {{ __('Switch To Proposal') }}
                                            </a>
                                            @endif
                                        </div>
                                        <div class="col-md-10">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-2">
                                            ...
                                            @if (\Auth::user()->bill_ipo == 0)
                                            <a href="{{ route('setview.setting',["bill_ipo",1]) }}" class="btn btn-sm btn-primary rounded-pill">
                                                {{ __('Switch To Ipo') }}
                                            </a>
                                            @else
                                            <a href="{{ route('setview.setting',["bill_ipo",0]) }}" class="btn btn-sm btn-primary rounded-pill">
                                                {{ __('Switch To Bill') }}
                                            </a>
                                            @endif 
