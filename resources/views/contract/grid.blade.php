...
@section('action-button')
    <div class="all-button-box row d-flex justify-content-end">
        ...
        @if (\Auth::user()->type == 'company')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('contract.create') }}" data-ajax-popup="true"
                    data-title="{{ __('Create New Contract') }}" class="btn btn-xs btn-white btn-icon-only width-auto"><i
                                    ...
                                    <div class="actions">
                                        <div class="dropdown action-item">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a href="#!" class="dropdown-item" data-toggle="tooltip"
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6 text-right">
                                        <span
                                            class="badge badge-secondary badge-pill">{{ !empty($contract->types) ? $contract->types->name : '' }}</span>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6 text-right">
                                        <span
                                            class="badge badge-secondary badge-pill">{{ \Auth::user()->priceFormat($contract->value) }}</span>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="h6 mb-0">{{ \Auth::user()->dateFormat($contract->end_date) }}
                                        </div>
                                    </div>
                                </div>
                            </li>
