<div class="card bg-none card-box mb-10">
    <div class="row">
        ...
        <div class="col-12 pb-2">
            <b>{{ __('Milestone') }}</b> :
            <span>{{ !empty($task->milestone) ? $task->milestone->title : '-' }}</span>
        </div>
        <div class="col-12">
        ...
        <div class="col-12 pb-4">
            <div class="progress" data-toggle="tooltip"
                data-original-title="{{ $task->taskProgress()['percentage'] }}">
                <div class="progress-bar bg-{{ $task->taskProgress()['color'] }}" role="progressbar"
                    aria-valuenow="{{ $task->taskProgress()['percentage'] }}" aria-valuemin="0" aria-valuemax="100"
