...
@section('action-button')
    <div class="row d-flex justify-content-end">
        ...
        @can('create proposal')
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="all-button-box">
                    <a href="{{ route('proposal.create', $customer->id) }}"
                        class="btn btn-xs btn-white btn-icon-only width-auto">
                        {{ __('Create Proposal') }}
                    </a>
                </div>
        ...
        @can('edit customer')
            <div class="col-xl-1 col-lg-2 col-md-2 col-sm-6 col-6">
                <div class="all-button-box">
                    <a href="#" data-size="2xl" data-url="{{ route('customer.edit', $customer['id']) }}"
                        data-ajax-popup="true" data-title="{{ __('Edit Customer') }}" data-toggle="tooltip"
                        data-original-title="{{ __('Edit') }}" class="btn btn-xs btn-white btn-icon-only width-auto">
        ...
        @can('delete customer')
            <div class="col-xl-1 col-lg-2 col-md-2 col-sm-6 col-6">
                <div class="all-button-box">
                    <a href="#" data-toggle="tooltip" data-original-title="{{ __('Delete') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="p-4">
                            ...
                            <h5 class="report-text mb-3">
                                {{ \Auth::user()->priceFormat($customer->customerOverdue($customer['id'])) }}</h5>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        @if (Gate::check('edit proposal') || Gate::check('delete proposal') || Gate::check('show proposal'))
                                            <td class="Action">
                                                <span>
                                                    @can('convert invoice')
                                                        <a href="#" class="edit-icon bg-yellow" data-toggle="tooltip"
                                ...
                                @foreach ($customer->customerInvoice($customer->id) as $invoice)
                                    <tr>
                                        <td class="Id">
                                            @if (\Auth::guard('customer')->check())
                                                <a
                                                    href="{{ route('customer.invoice.show', \Crypt::encrypt($invoice->id)) }}">{{ AUth::user()->invoiceNumberFormat($invoice->invoice_id) }}
                                                </a>
                                            @else
