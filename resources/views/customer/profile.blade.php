                    ...
                    <div class="row">
                        <ul class="nav nav-tabs my-4">
                            ...
                            <li class="annual-billing">
                                <a data-toggle="tab" href="#billing-info"
                                    class="">{{ __('Billing Info') }}</span> </a>
                            </li>
                            <li class="annual-billing">
                                <a data-toggle="tab" href="#shipping-info"
                                    class="">{{ __('Shipping Info') }}</span> </a>
                            </li>
                            <li class="annual-billing">
                        ...
                        <div class="tab-content">
                            <div id="personal-info" class="tab-pane in active">
                                {{ Form::model($userDetail, ['route' => ['customer.update.profile'], 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
                                <div class="row">
                                    <div class="col-md-6">
                            ...
                            <div id="billing-info" class="tab-pane">
                                {{ Form::model($userDetail, ['route' => ['customer.update.billing.info'], 'method' => 'post']) }}
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                            ...
                            <div id="shipping-info" class="tab-pane">
                                {{ Form::model($userDetail, ['route' => ['customer.update.shipping.info'], 'method' => 'post']) }}
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                            ...
                            <div id="change-password" class="tab-pane">
                                {{ Form::model($userDetail, ['route' => ['customer.update.password', $userDetail->id], 'method' => 'post']) }}
                                <div class="row">
