                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Subject : ') . 'We are writing to inform you that we has sent your ' . $payment->bill . ' payment.' }}</b>
                                                                        </p>
                                                                        <p style="line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Hi ') . $payment->name . ',' }}</b>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 10px 0;">
                                                                            {{ __('We has sent your amount ' . $payment->amount . ' payment for ' . $payment->bill . ' submited on date ' . $payment->date . ' via ' . $payment->method . '.') }}
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 10px 0;"><i
                                                                                style="font-style:normal"><b
                                                                                    style="font-weight:700">{{ __('Best Regards,') }}</b></i>
                                                                        </p>
                                                                        <p style="margin: 10px 0;"><i
                                                                                style="font-style:normal"><b
