                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Subject : ') . 'New lead has been Assign to you.' }}</b>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Name : ') . $lArr['lead_name'] }}</b>
                                                                        </p>
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Email : ') . $lArr['lead_email'] }}</b>
                                                                        </p>
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Pipeline : ') . $lArr['lead_pipeline'] }}</b>
                                                                        </p>
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Stage : ') . $lArr['lead_stage'] }}</b>
                                                                        </p>
