                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Subject : ') . 'Product/Service bill (' . $bill->bill . ').' }}</b>
                                                                        </p>
                                                                        <p style="line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Hi ') . $bill->name . ',' }}</b>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 10px 0;">
                                                                            {{ __('Hope this email ﬁnds you well! Please see attached bill number ' . $bill->bill . ' for product/service.') }}
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                            ...
                                                                            <td align="center" bgcolor="#6676EF"
                                                                                ...
                                                                                <a href="{{ $bill->url }}"
                                                                                    ...
                                                                                    <b style="font-weight:700"><b
                                                                                            style="font-weight:700">{{ __('Bill') }}</b></b>
                                                                                </a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
