                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Subject : ') . 'HR department/Company to send ticket for ' . $ticket->title }}</b>
                                                                        </p>
                                                                        <p style="line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Hi ') . $ticket->name . ',' }}</b>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 10px 0;">
                                                                            {{ __('Hope this email ﬁnds you well! , Your ticket code is ' . $ticket->ticket_code) }}
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
