                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Hello ') . ',' }}</b>
                                                                        </p>
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Subject : ') . 'New Deal has been Assign to you.' }}</b>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Name : ') . $dArr['deal_name'] }}</b>
                                                                        </p>
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Pipeline : ') . $dArr['deal_pipeline'] }}</b>
                                                                        </p>
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Stage : ') . $dArr['deal_stage'] }}</b>
                                                                        </p>
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Status : ') . $dArr['deal_status'] }}</b>
                                                                        </p>
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Price : ') . $dArr['deal_price'] }}</b>
                                                                        </p>
