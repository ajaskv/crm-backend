                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Subject : ') . 'HR department/Company to send termination letter.' }}</b>
                                                                        </p>
                                                                        <p style="line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Dear ') . $termination->name . ',' }}</b>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
