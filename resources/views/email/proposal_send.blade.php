                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Subject : ') . 'Product/Service proposal (' . $proposal->proposal . ').' }}</b>
                                                                        </p>
                                                                        <p style="line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Hi ') . $proposal->name . ',' }}</b>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 10px 0;">
                                                                            {{ __('Hope this email ﬁnds you well! Please see attached proposal number ' . $proposal->proposal . ' for product/service.') }}
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                            ...
                                                                            <td align="center" bgcolor="#6676EF"
                                                                                ...
                                                                                <a href="{{ $proposal->url }}"
                                                                                    ...
                                                                                    <b style="font-weight:700"><b
                                                                                            style="font-weight:700">{{ __('Proposal') }}</b></b>
                                                                                </a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
