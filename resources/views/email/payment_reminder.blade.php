                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Subject : ') . 'Follow-up on invoice ' . $payment->invoice . ' payment.' }}</b>
                                                                        </p>
                                                                        <p style="line-height:32px"><b
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 10px 0;"><i
                                                                                style="font-style:normal">{{ __('I’m sure you’re busy, but I’d appreciate if you could take a moment and look over the invoice when you get a chance.') }}</i>
                                                                        </p>
                                                                        <p style="margin: 10px 0;"><i
                                                                                style="font-style:normal">{{ __(' If you have any questions whatsoever, please reply and I’d be happy to clarify them.') }}</i>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 10px 0;"><i
                                                                                style="font-style:normal"><b
                                                                                    style="font-weight:700">{{ __('Thanks,') }}</b></i>
                                                                        </p>
                                                                        <p style="margin: 10px 0;"><i
                                                                                style="font-style:normal"><b
