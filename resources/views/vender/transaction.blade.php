                ...
                <div class="card-body py-0">
                    <div class="row d-flex justify-content-end mt-2">
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                            {{ Form::open(['route' => ['vender.transaction'], 'method' => 'GET', 'id' => 'frm_submit']) }}
                            <div class="all-select-box">
                                <div class="btn-box">
                                    {{ Form::label('date', __('Date'), ['class' => 'text-type']) }}
                                    {{ Form::text('date', isset($_GET['date']) ? $_GET['date'] : null, ['class' => 'form-control datepicker-range']) }}
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                            <div class="all-select-box">
                                <div class="btn-box">
                                    ...
                                    {{ Form::select('category', ['' => 'All'] + $category, isset($_GET['category']) ? $_GET['category'] : '', ['class' => 'form-control select2']) }}
                                </div>
                            </div>
                        </div>
