    ...
    <div class="row d-flex justify-content-end">
        ...
        @can('edit vender')
            <div class="col-xl-1 col-lg-2 col-md-2 col-sm-6 col-6">
                <div class="all-button-box">
                    <a href="#" class="btn btn-xs btn-white btn-icon-only width-auto" data-size="2xl"
                        data-url="{{ route('vender.edit', $vendor['id']) }}" data-ajax-popup="true"
                        data-title="{{ __('Edit Vendor') }}" data-toggle="tooltip" data-original-title="{{ __('Edit') }}">
        ...
        @can('delete vender')
            <div class="col-xl-1 col-lg-2 col-md-2 col-sm-6 col-6">
                <div class="all-button-box">
                    <a href="#" class="btn btn-xs btn-white bg-danger btn-icon-only width-auto" data-toggle="tooltip"
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="p-4">
                            ...
                            <h5 class="report-text mb-3">
                                {{ \Auth::user()->priceFormat($vendor->vendorOverdue($vendor->id)) }}</h5>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr class="font-style">
                                        ...
                                        <td>
                                            @if ($bill->due_date < date('Y-m-d'))
                                                <p class="text-danger">
                                                    {{ \Auth::user()->dateFormat($bill->due_date) }}</p>
                                            @else
