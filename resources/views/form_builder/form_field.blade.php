<div class="card bg-none card-box">
    {{ Form::model($formField, ['route' => ['form.bind.store', $form->id]]) }}
    <div class="row">
        ...
        <div class="col-8">
            <div class="d-flex radio-check">
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="on" value="1" name="is_lead_active" class="custom-control-input lead_radio"
                        {{ $form->is_lead_active == 1 ? 'checked' : '' }}>
                    <label class="custom-control-label form-control-label" for="on">{{ __('On') }}</label>
                </div>
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="off" value="0" name="is_lead_active" class="custom-control-input lead_radio"
                        {{ $form->is_lead_active == 0 ? 'checked' : '' }}>
    ...
    <div id="lead_activated" class="d-none">
        <div class="row px-2">
            ...
            <div class="col-8">
                <div class="form-group">
                    {{ Form::select('subject_id', $types, null, ['class' => 'form-control', 'data-toggle' => 'select']) }}
                </div>
            </div>
            <div class="col-4">
                <div class="form-group">
            ...
            <div class="col-8">
                <div class="form-group">
                    {{ Form::select('name_id', $types, null, ['class' => 'form-control', 'data-toggle' => 'select']) }}
                </div>
            </div>
            <div class="col-4">
            ...
            <div class="col-8">
                <div class="form-group">
                    {{ Form::select('email_id', $types, null, ['class' => 'form-control', 'data-toggle' => 'select']) }}
                </div>
            ...
            <div class="col-8">
                <div class="form-group">
                    {{ Form::select('user_id', $users, null, ['class' => 'form-control', 'data-toggle' => 'select']) }}
                    @if (count($users) == 0)
            ...
            <div class="col-8">
                <div class="form-group">
                    {{ Form::select('pipeline_id', $pipelines, null, ['class' => 'form-control', 'data-toggle' => 'select']) }}
                </div>
            </div>
        </div>
    </div>
