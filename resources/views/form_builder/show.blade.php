...
@section('action-button')
    @can('create form field')
        <a href="#" data-size='md' data-url="{{ route('form.field.create', $formBuilder->id) }}" data-size="md"
            data-ajax-popup="true" data-title="{{ __('Create New Filed') }}"
                                ...
                                <td class="text-right">
                                    @can('edit form field')
                                        <a href="#" class="action-item"
                                            ...
                                            data-ajax-popup="true" data-title="{{ __('Edit Field') }}" data-toggle="tooltip"
