        ...
        <div class="div-mega">
                    ...
                    @if (Gate::check('show hrm dashboard') || Gate::check('show project dashboard') || Gate::check('show account dashboard'))
                        ...
                        @if (\Auth::user()->show_project() == 1)
                            @can('show project dashboard')
                                <li
                                    class="nav-item {{ Request::route()->getName() == 'project.dashboard' ? ' active' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ route('customer.quotation') }}"
                    class="nav-link {{ Request::route()->getName() == 'customer.quotation' || Request::route()->getName() == 'customer.quotation.show' ? ' active' : '' }}">
                    <i class="fas fa-file"></i>{{ __('Quation') }}
                </a>
            </li>
        @endcan
            ...
            @else
                ...
                @if (Gate::check('manage product & service'))
                    <li class="nav-item">
                        <a href="{{ route('productstock.index') }}"
                            class="nav-link {{ Request::segment(1) == 'productstock' ? 'active' : '' }}">
                            ...
                            <div class="collapse {{ Request::segment(1) == 'stages' || Request::segment(1) == 'labels' || Request::segment(1) == 'sources' || Request::segment(1) == 'lead_stages' || Request::segment(1) == 'leads' || Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' || Request::segment(1) == 'deals' || Request::segment(1) == 'pipelines' ? 'show' : '' }}"
                                ...
                                <ul class="nav flex-column">
                                    ...
                                    @can('manage form builder')
                                        <li
                                            class="nav-item {{ Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? 'active open' : '' }}">
                                                        ...
                                                        <li class="nav-item submenu-li ">
                                                            ...
                                                            <div class="submenu-ul {{ Request::segment(1) == 'stages' || Request::segment(1) == 'labels' || Request::segment(1) == 'sources' || Request::segment(1) == 'lead_stages' || Request::segment(1) == 'pipelines' || Request::segment(1) == 'product-category' || Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type' ? 'show' : 'collapse' }}"
                                                                ...
                                                                <ul class="nav flex-column">
                                                                    @can('manage pipeline')
                                                                        <li
                                                                            class="nav-item {{ Request::route()->getName() == 'pipelines.index' ? ' active' : '' }}">
                                                                    ...
                                                                    @can('manage lead stage')
                                                                        <li
                                                                            class="nav-item {{ Request::route()->getName() == 'lead_stages.index' ? 'active' : '' }}">
                                                                    ...
                                                                    @can('manage stage')
                                                                        <li
                                                                            class="nav-item {{ Request::route()->getName() == 'stages.index' ? 'active' : '' }}">
                                                                    ...
                                                                    @can('manage source')
                                                                        <li
                                                                            class="nav-item {{ Request::route()->getName() == 'sources.index' ? ' active' : '' }}">
                                                                    ...
                                                                    @can('manage label')
                                                                        <li
                                                                            class="nav-item {{ Request::route()->getName() == 'labels.index' ? 'active' : '' }}">
                                                                            <a href="{{ route('labels.index') }}"
                                                                                class="nav-link">{{ __('Labels') }}</a>
                                                                        </li>
                                                                    @endcan
                                                                    <li
                                                                        class="nav-item {{ Request::segment(1) == 'contractType' ? 'active open' : '' }}">
                    ...
                    @if (Gate::check('manage project'))
                        <li class="nav-item">
                            <a class="nav-link {{ Request::segment(1) == 'bugs-report' || Request::segment(1) == 'bugstatus' || Request::segment(1) == 'project-task-stages' || Request::segment(1) == 'calendar' || Request::segment(1) == 'timesheet-list' || Request::segment(1) == 'taskboard' || Request::segment(1) == 'timesheet-list' || Request::segment(1) == 'taskboard' || Request::segment(1) == 'project' || Request::segment(1) == 'projects' ? 'active' : 'collapsed' }}"
                                href="#taskGo" data-toggle="collapse" role="button"
                            ...
                            <div class="collapse {{ Request::segment(1) == 'bugs-report' || Request::segment(1) == 'project' || Request::segment(1) == 'bugstatus' || Request::segment(1) == 'project-task-stages' || Request::segment(1) == 'calendar' || Request::segment(1) == 'timesheet-list' || Request::segment(1) == 'taskboard' || Request::segment(1) == 'timesheet-list' || Request::segment(1) == 'taskboard' || Request::segment(1) == 'project' || Request::segment(1) == 'projects' ? 'show' : '' }}"
                                ...
                                <ul class="nav flex-column">
                                    @can('manage project')
                                        <li
                                            class="nav-item  {{ Request::segment(1) == 'project' || Request::route()->getName() == 'projects.list' || Request::route()->getName() == 'projects.list' || Request::route()->getName() == 'projects.index' || Request::route()->getName() == 'projects.show' || request()->is('projects/*') ? 'active' : '' }}">
                                    ...
                                    @if (\Auth::user()->type != 'super admin')
                                        <li
                                            class="nav-item {{ Request::segment(1) == 'time-tracker' ? 'active open' : '' }}">
                                                    ...
                                                    <ul class="nav flex-column">
                                                        <li class="nav-item submenu-li">
                                                            <a class="nav-link {{ Request::segment(1) == 'bugstatus' || Request::segment(1) == 'project-task-stages' ? 'active' : 'collapsed' }}"
                                                                href="#taskgo_navbar_constants" data-toggle="collapse"
                                                                role="button"
                                                            ...
                                                            <div class="submenu-ul {{ Request::segment(1) == 'bugstatus' || Request::segment(1) == 'project-task-stages' ? 'show' : 'collapse' }}"
                                                                ...
                                                                <ul class="nav flex-column">
                                                                    @can('manage project task stage')
                                                                        <li
                                                                            class="nav-item {{ Request::route()->getName() == 'project-task-stages.index' ? 'active' : '' }}">
                                                                            <a class="nav-link"
                                                                    ...
                                                                    @can('manage bug status')
                                                                        <li
                                                                            class="nav-item {{ Request::route()->getName() == 'bugstatus.index' ? 'active' : '' }}">
                                                                            <a class="nav-link"
                ...
                @if (\Auth::user()->show_hrm() == 1)
                    @if (Gate::check('manage employee') || Gate::check('manage setsalary'))
                        <li class="nav-item">
                            <a class="nav-link {{ Request::segment(1) == 'holiday-calender' ||
                            ...
                            <div class="collapse {{ Request::segment(1) == 'holiday-calender' ||
                            Request::segment(1) == 'reports-monthly-attendance' ||
                            Request::segment(1) == 'reports-leave' ||
                            Request::segment(1) == 'performanceType' ||
                            Request::segment(1) == 'reports-payroll' ||
                                    ...
                                    <li class="nav-item">
                                        <div class="collapse show" id="navbar-accounting8" style="">
                                            <ul class="nav flex-column">
                                                <ul class="nav flex-column">
                                                    <li
                                                        class="nav-item  {{ Request::segment(1) == 'employee' ? 'active' : '' }}">
                                                    ...
                                                    <li class="nav-item submenu-li ">
                                                        ...
                                                        <div class="submenu-ul {{ Request::segment(1) == 'setsalary' || Request::segment(1) == 'payslip' ? 'show' : 'collapse' }}"
                                                            id="navbar-accounting8-users" style="">
                                                            <ul class="nav flex-column">
                                                                @can('manage set salary')
                                                                    <li
                                                                        class="nav-item {{ request()->is('setsalary*') ? 'active' : '' }}">
                                                                ...
                                                                @can('manage pay slip')
                                                                    <li
                                                                        class="nav-item {{ request()->is('payslip*') ? 'active' : '' }}">
                                                ...
                                                <li class="nav-item submenu-li ">
                                                    ...
                                                    <div class="submenu-ul {{ Request::segment(1) == 'leave' || Request::segment(1) == 'attendanceemployee' ? 'show' : 'collapse' }}"
                                                        ...
                                                        <ul class="nav flex-column">
                                                            @can('manage leave')
                                                                <li
                                                                    class="nav-item {{ Request::route()->getName() == 'leave.index' ? 'active' : '' }}">
                                                        ...
                                                        <div class="submenu-ul {{ Request::segment(1) == 'indicator' || Request::segment(1) == 'appraisal' || Request::segment(1) == 'goaltracking' ? 'show' : 'collapse' }}"
                                                            ...
                                                            <ul class="nav flex-column">
                                                                @can('manage indicator')
                                                                    <li
                                                                        class="nav-item {{ request()->is('indicator*') ? 'active' : '' }}">
                                                                ...
                                                                @can('manage appraisal')
                                                                    <li
                                                                        class="nav-item {{ request()->is('appraisal*') ? 'active' : '' }}">
                                                                ...
                                                                @can('manage goal tracking')
                                                                    <li
                                                                        class="nav-item {{ request()->is('goaltracking*') ? 'active' : '' }}">
                                                    ...
                                                    <li class="nav-item submenu-li ">
                                                        ...
                                                        <div class="submenu-ul {{ Request::segment(1) == 'trainer' || Request::segment(1) == 'training' ? 'show' : 'collapse' }}"
                                                            ...
                                                            <ul class="nav flex-column">
                                                                ...
                                                                @can('manage trainer')
                                                                    <li
                                                                        class="nav-item {{ request()->is('trainer*') ? 'active' : '' }}">
                                                ...
                                                <ul class="nav flex-column">
                                                    <li class="nav-item submenu-li">
                                                        <a class="nav-link {{ Request::segment(1) == 'job' || Request::segment(1) == 'job-application' || Request::segment(1) == 'candidates-job-applications' || Request::segment(1) == 'job-onboard' || Request::segment(1) == 'custom-question' || Request::segment(1) == 'interview-schedule' || Request::segment(1) == 'career' ? 'active' : 'collapsed' }}"
                                                            href="#navbar-recruitment" data-toggle="collapse" role="button"
                                                        ...
                                                        <div class="submenu-ul {{ Request::segment(1) == 'job' || Request::segment(1) == 'job-application' || Request::segment(1) == 'candidates-job-applications' || Request::segment(1) == 'job-onboard' || Request::segment(1) == 'custom-question' || Request::segment(1) == 'interview-schedule' || Request::segment(1) == 'career' ? 'show' : 'collapse' }}"
                                                            ...
                                                            <ul class="nav flex-column">
                                                                @can('manage job')
                                                                    <li
                                                                        class="nav-item {{ Request::route()->getName() == 'job.index' || Request::route()->getName() == 'job.create' ? 'active' : '' }}">
                                                                ...
                                                                @can('manage job application')
                                                                    <li
                                                                        class="nav-item {{ request()->is('job-application*') ? 'active' : '' }}">
                                                                ...
                                                                @can('manage job application')
                                                                    <li
                                                                        class="nav-item {{ request()->is('candidates-job-applications') ? 'active' : '' }}">
                                                                ...
                                                                @can('manage job application')
                                                                    <li
                                                                        class="nav-item {{ request()->is('job-onboard*') ? 'active' : '' }}">
                                                                ...
                                                                @can('manage custom question')
                                                                    <li
                                                                        class="nav-item {{ request()->is('custom-question*') ? 'active' : '' }}">
                                                                ...
                                                                @can('show interview schedule')
                                                                    <li
                                                                        class="nav-item {{ request()->is('interview-schedule*') ? 'active' : '' }}">
                                                                ...
                                                                @can('show career')
                                                                    <li
                                                                        class="nav-item {{ request()->is('career*') ? 'active' : '' }}">
                                                ...
                                                <li class="nav-item submenu-li ">
                                                    ...
                                                    <div class="submenu-ul collapse{{ Request::segment(1) == 'holiday-calender' || Request::segment(1) == 'holiday' || Request::segment(1) == 'award' || Request::segment(1) == 'transfer' || Request::segment(1) == 'resignation' || Request::segment(1) == 'travel' || Request::segment(1) == 'promotion' || Request::segment(1) == 'complaint' || Request::segment(1) == 'warning' || Request::segment(1) == 'termination' || Request::segment(1) == 'announcement' || Request::segment(1) == 'policies' ? 'show' : '' }}"
                                                        ...
                                                        <ul class="nav flex-column">
                                                            @can('manage award')
                                                                <li
                                                                    class="nav-item {{ request()->is('award*') ? 'active' : '' }}">
                                                            ...
                                                            @can('manage transfer')
                                                                <li
                                                                    class="nav-item {{ request()->is('transfer*') ? 'active' : '' }}">
                                                            ...
                                                            @can('manage resignation')
                                                                <li
                                                                    class="nav-item {{ request()->is('resignation*') ? 'active' : '' }}">
                                                            ...
                                                            @can('manage travel')
                                                                <li
                                                                    class="nav-item {{ request()->is('travel*') ? 'active' : '' }}">
                                                            ...
                                                            @can('manage promotion')
                                                                <li
                                                                    class="nav-item {{ request()->is('promotion*') ? 'active' : '' }}">
                                                            ...
                                                            @can('manage complaint')
                                                                <li
                                                                    class="nav-item {{ request()->is('complaint*') ? 'active' : '' }}">
                                                            ...
                                                            @can('manage warning')
                                                                <li
                                                                    class="nav-item {{ request()->is('warning*') ? 'active' : '' }}">
                                                            ...
                                                            @can('manage termination')
                                                                <li
                                                                    class="nav-item {{ request()->is('termination*') ? 'active' : '' }}">
                                                            ...
                                                            @can('manage announcement')
                                                                <li
                                                                    class="nav-item {{ request()->is('announcement*') ? 'active' : '' }}">
                                                            ...
                                                            @can('manage holiday')
                                                                <li
                                                                    class="nav-item {{ request()->is('holiday*') || request()->is('holiday-calender') ? 'active' : '' }}">
                                                        ...
                                                        <li class="nav-item submenu-li ">
                                                            ...
                                                            <div class="submenu-ul collapse{{ Request::segment(1) == 'reports-monthly-attendance' || Request::segment(1) == 'reports-leave' || Request::segment(1) == 'reports-payroll' ? 'show' : '' }}"
                                                                ...
                                                                <ul class="nav flex-column">
                                                                    ...
                                                                    <li
                                                                        class="nav-item {{ request()->is('reports-leave') ? 'active' : '' }}">
                                                                        <a class="nav-link"
                                                                            href="{{ route('report.leave') }}">{{ __('Leave') }}</a>
                                                                    </li>
                                                                    <li
                                                                        class="nav-item {{ request()->is('reports-payroll') ? 'active' : '' }}">
                                                                        <a class="nav-link"
                                    ...
                                    <li class="nav-item">
                                        <div class="collapse show" id="hrmgo_constants" style="">
                                            <ul class="nav flex-column">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item submenu-li">
                                                        <a class="nav-link {{ Request::segment(1) == 'leavetype' ||
                                                        Request::segment(1) == 'document' ||
                                                        Request::segment(1) == 'performanceType' ||
                                                        Request::segment(1) == 'branch' ||
                                                        Request::segment(1) == 'department' ||
                                                        ...
                                                        <div class="submenu-ul {{ Request::segment(1) == 'leavetype' ||
                                                        Request::segment(1) == 'document' ||
                                                        Request::segment(1) == 'performanceType' ||
                                                        Request::segment(1) == 'branch' ||
                                                        Request::segment(1) == 'department' ||
                                                        ...
                                                        Request::segment(1) == 'deductionoption'
                                                            ...
                                                            <ul class="nav flex-column">
                                                                ...
                                                                @can('manage leave type')
                                                                    <li
                                                                        class="nav-item {{ Request::route()->getName() == 'leavetype.index' ? 'active' : '' }}">
                                                                ...
                                                                @can('manage document type')
                                                                    <li
                                                                        class="nav-item {{ Request::route()->getName() == 'document.index' ? 'active' : '' }}">
                                                                ...
                                                                @can('manage payslip type')
                                                                    <li
                                                                        class="nav-item {{ request()->is('paysliptype*') ? 'active' : '' }}">
                                                                ...
                                                                @can('manage allowance option')
                                                                    <li
                                                                        class="nav-item {{ request()->is('allowanceoption*') ? 'active' : '' }}">
                                                                ...
                                                                @can('manage loan option')
                                                                    <li
                                                                        class="nav-item {{ request()->is('loanoption*') ? 'active' : '' }}">
                                                                ...
                                                                @can('manage deduction option')
                                                                    <li
                                                                        class="nav-item {{ request()->is('deductionoption*') ? 'active' : '' }}">
                                                                ...
                                                                @can('manage training type')
                                                                    <li
                                                                        class="nav-item {{ request()->is('trainingtype*') ? 'active' : '' }}">
                                                                ...
                                                                @can('manage job category')
                                                                    <li
                                                                        class="nav-item {{ request()->is('job-category*') ? 'active' : '' }}">
                                                                ...
                                                                @can('manage job stage')
                                                                    <li
                                                                        class="nav-item {{ request()->is('job-stage*') ? 'active' : '' }}">
                            ...
                            <div class="collapse {{ Request::segment(1) == 'print-setting' ||Request::segment(1) == 'customer' ||Request::segment(1) == 'vender' ||Request::segment(1) == 'proposal' ||Request::segment(1) == 'bank-account' ||Request::segment(1) == 'bank-transfer' ||Request::segment(1) == 'invoice' ||Request::segment(1) == 'revenue' ||Request::segment(1) == 'credit-note' ||Request::segment(1) == 'taxes' ||Request::segment(1) == 'product-category' ||Request::segment(1) == 'product-unit' ||Request::segment(1) == 'payment-method' ||Request::segment(1) == 'custom-field' ||Request::segment(1) == 'chart-of-account-type' ||((Request::segment(1) == 'report' || Request::segment(1) == 'transaction') && Request::segment(2) != 'ledger' && Request::segment(2) != 'balance-sheet' && Request::segment(2) != 'trial-balance') ||Request::segment(1) == 'goal' ||Request::segment(1) == 'budget' ||Request::segment(1) == 'chart-of-account' ||Request::segment(1) == 'journal-entry' ||Request::segment(2) == 'ledger' ||Request::segment(2) == 'balance-sheet' ||Request::segment(2) == 'trial-balance' ||Request::segment(1) == 'bill' ||Request::segment(1) == 'payment' ||Request::segment(1) == 'debit-note'? 'show': '' }}"
                                ...
                                <ul class="nav flex-column">
                                                    ...
                                                    <ul class="nav flex-column">
                                                        <li class="nav-item submenu-li ">
                                                            <a class="nav-link {{ Request::segment(1) == 'bank-account' || Request::segment(1) == 'bank-transfer' ? 'active' : 'collapsed' }}"
                                                                href="#banking-nav" data-toggle="collapse" role="button"
                                                            ...
                                                            <div class="submenu-ul {{ Request::segment(1) == 'bank-account' || Request::segment(1) == 'bank-transfer' ? 'show' : 'collapse' }}"
                                                                ...
                                                                <ul class="nav flex-column">
                                                                    ...
                                                                    @can('manage bank transfer')
                                                                        <li
                                                                            class="nav-item {{ Request::route()->getName() == 'bank-transfer.index' || Request::route()->getName() == 'bank-transfer.create' || Request::route()->getName() == 'bank-transfer.edit' ? ' active' : '' }}">
                                                    ...
                                                    <ul class="nav flex-column">
                                                        <li class="nav-item submenu-li ">
                                                            <a class="nav-link {{ Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note' ? 'active' : 'collapsed' }}"
                                                                href="#income-nav" data-toggle="collapse" role="button"
                                                    ...
                                                    <ul class="nav flex-column">
                                                        <li class="nav-item submenu-li ">
                                                            <a class="nav-link {{ Request::segment(1) == 'bill' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note' ? 'active' : 'collapsed' }}"
                                                                href="#expense-nav" data-toggle="collapse" role="button"
                                                    ...
                                                    <ul class="nav flex-column">
                                                        <li class="nav-item submenu-li ">
                                                            <a class="nav-link {{ (Request::segment(1) == 'report' || Request::segment(1) == 'transaction') && Request::segment(2) != 'ledger' && Request::segment(2) != 'balance-sheet' && Request::segment(2) != 'trial-balance' ? 'active' : 'collapsed' }}"
                                                                href="#report-nav" data-toggle="collapse" role="button"
                                                            ...
                                                            <div class="submenu-ul {{ (Request::segment(1) == 'report' || Request::segment(1) == 'transaction') && Request::segment(2) != 'ledger' && Request::segment(2) != 'balance-sheet' && Request::segment(2) != 'trial-balance' ? 'show' : 'collapse' }}"
                                                                ...
                                                                <ul class="nav flex-column">
                                                                    ...
                                                                    @can('stock report')
                                                                        <li
                                                                            class="nav-item {{ Request::route()->getName() == 'report.product.stock.report' ? ' active' : '' }}">
                                                                            <a href="{{ route('report.product.stock.report') }}"
                                                                                class="nav-link">{{ __('Product Stock') }}</a>
                                                                        </li>
                                                                    @endcan
                                                                </ul>
                                                            </div>
                                    ...
                                    @if (Gate::check('manage print settings'))
                                        <li
                                            class="nav-item {{ Request::segment(1) == 'print-setting' ? ' active' : '' }}">
