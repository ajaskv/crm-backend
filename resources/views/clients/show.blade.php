    ...
    <div class="row">
        ...
        <div class="col">
            <div class="card p-4 mb-4">
                ...
                <h5 class="report-text mb-0">{{ $cnt_estimation['this_month'] }} /
                    {{ $cnt_estimation['cnt_this_month'] }}
                </h5>
            </div>
        </div>
        <div class="col">
            <div class="card p-4 mb-4">
                ...
                <h5 class="report-text mb-0">{{ $cnt_estimation['this_week'] }} /
                    {{ $cnt_estimation['cnt_this_week'] }}
                </h5>
            </div>
        </div>
        <div class="col">
            <div class="card p-4 mb-4">
                ...
                <h5 class="report-text mb-0">{{ $cnt_estimation['last_30days'] }} /
                    {{ $cnt_estimation['cnt_last_30days'] }}</h5>
            </div>
        </div>
