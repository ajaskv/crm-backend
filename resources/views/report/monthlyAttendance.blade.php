...
@section('action-button')
    <div class="row d-flex justify-content-end">
        ...
        <div class="col-auto my-custom">
            ...
            <a href="{{ route('report.attendance', [isset($_GET['month']) ? $_GET['month'] : date('Y-m'), isset($_GET['branch']) ? $_GET['branch'] : 0, isset($_GET['department']) ? $_GET['department'] : 0]) }}"
                class="action-btn">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6 col-lg-3">
                <div class="card p-4 mb-4">
                    ...
                    <h5 class="report-text mb-0">{{ __('Total overtime in hours') }} :
                        {{ number_format($data['totalOvertime'], 2) }}</h5>
                </div>
            </div>
            <div class="col-xl-3 col-md-6 col-lg-3">
                <div class="card p-4 mb-4">
                    <h5 class="report-text gray-text mb-0">{{ __('Early leave') }}</h5>
                    <h5 class="report-text mb-0">{{ __('Total early leave in hours') }} :
                        {{ number_format($data['totalEarlyLeave'], 2) }}</h5>
                </div>
            </div>
            <div class="col-xl-3 col-md-6 col-lg-3">
                <div class="card p-4 mb-4">
                    <h5 class="report-text gray-text mb-0">{{ __('Employee late') }}</h5>
                    <h5 class="report-text mb-0">{{ __('Total late in hours') }} :
                        {{ number_format($data['totalLate'], 2) }}</h5>
                </div>
            </div>
        </div>
