        ...
        <div class="col">
            <div class="all-select-box">
                <div class="btn-box">
                    ...
                    {{ Form::select('type', $types, isset($_GET['type']) ? $_GET['type'] : '', ['class' => 'form-control select2']) }}
                </div>
            </div>
        </div>
        <div class="col-auto my-custom">
            <a href="#" class="apply-btn" onclick="document.getElementById('report_account').submit(); return false;"
