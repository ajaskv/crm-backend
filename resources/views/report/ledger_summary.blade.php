...
@section('action-button')
    <div class="row d-flex justify-content-end">
        ...
        <div class="col-auto my-custom">
            <a href="#" class="apply-btn" onclick="document.getElementById('report_ledger').submit(); return false;"
                data-toggle="tooltip" data-original-title="{{ __('apply') }}">
                <span class="btn-inner--icon"><i class="fas fa-search"></i></span>
            </a>
            <a href="{{ route('report.ledger') }}" class="reset-btn" data-toggle="tooltip"
                    ...
                    <tbody>
                        ...
                        @foreach ($journalItems as $item)
                            <tr>
                                <td class="Id">
                                    <a
                                        href="{{ route('journal-entry.show', $item->journal) }}">{{ AUth::user()->journalNumberFormat($item->journal_id) }}</a>
                                </td>
