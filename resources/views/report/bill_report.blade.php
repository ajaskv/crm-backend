    ...
    <div class="row d-flex justify-content-end">
        ...
        <div class="col-auto my-custom">
            <a href="#" class="apply-btn"
                onclick="document.getElementById('report_bill_summary').submit(); return false;" data-toggle="tooltip"
                data-original-title="{{ __('apply') }}">
                <span class="btn-inner--icon"><i class="fas fa-search"></i></span>
            </a>
            <a href="{{ route('report.bill.summary') }}" class="reset-btn" data-toggle="tooltip"
                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between w-100">
                            <ul class="nav nav-pills mb-3" id="myTab3" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link btn-xs" id="contact-tab4" data-toggle="tab" href="#bills" role="tab"
                                        aria-controls="" aria-selected="false">{{ __('Bills') }}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
