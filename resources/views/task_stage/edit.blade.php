<div class="card bg-none card-box">
    {{ Form::model($taskStage, ['route' => ['project-task-stages.update', $taskStage->id], 'method' => 'PUT']) }}
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                {{ Form::label('name', __('Project Task Stage Title'), ['class' => 'form-control-label']) }}
                {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => __('Enter project stage title')]) }}
            </div>
        </div>
