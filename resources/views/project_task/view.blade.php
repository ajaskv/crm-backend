                    ...
                    <div class="actions text-right">
                        <div class="float-left">
                            <a href="#" class="action-item {{ $task->is_favourite ? 'action-favorite' : '' }} active"
                                data-url="{{ route('change.fav', [$task->project_id, $task->id]) }}"
                                id="add_favourite" data-toggle="tooltip"
                                data-original-title="{{ __('Mark as favorite') }}">
                                <i class="fas fa-star"></i>
                            </a>
                        </div>
                        <div class="priority-color float-right">
                            <div class="colorPickSelector" style="background-color: {{ $task->priority_color }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <div class="row mb-4 align-items-center">
                        ...
                        <div class="col-6 text-right">
                            <a href="#" class="btn btn-sm btn-white float-right add-small" data-toggle="collapse"
                                    ...
                                    <div class="col-auto">
                                        <a href="#" class="avatar avatar-sm">
                                            <img data-toggle="tooltip"
                                                ...
                                                title="{{ $user->name }}" class="avatar avatar-sm rounded-circle">
                                        </a>
                                    </div>
                                    <div class="col ml-n2">
                                        ...
                                        <small
                                            class="d-block">{{ $activity->created_at->diffForHumans() }}</small>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                ...
                <div class="col-12 d-flex">
                    <div class="pr-3">
                        <img data-original-title="{{ !empty(\Auth::user()) ? \Auth::user()->name : '' }}"
                            @if (\Auth::user()->avatar) src="{{ asset('/storage/uploads/avatar/' . \Auth::user()->avatar) }}" @else src="{{ asset('assets/img/avatar/avatar-1.png') }}" @endif
                            title="{{ Auth::user()->name }}" class="avatar rounded-circle avatar-sm">
                    </div>
