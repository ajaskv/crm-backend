    ...
    <div class="row">
        <div class="col-8">
            <div class="form-group">
                {{ Form::label('name', __('Task name'), ['class' => 'form-control-label']) }}<span
        ...
        <div class="col-6">
            <div class="form-group">
                {{ Form::label('estimated_hrs', __('Estimated Hours'), ['class' => 'form-control-label']) }}<span
                    class="text-danger">*</span>
                <small
                ...
                <div class="col-6">
                    <div class="list-group-item px-0">
                        <div class="row align-items-center">
                            ...
                            @endphp
                            <div class="col-auto text-right add_usr {{ in_array($user->id, $usrs) ? 'selected' : '' }}"
                                data-id="{{ $user->id }}">
                                <button type="button"
                                    class="btn btn-xs btn-animated btn-blue rounded-pill btn-animated-y mr-3">
                                    <span class="btn-inner--visible">
                                        <i class="fas fa-{{ in_array($user->id, $usrs) ? 'check' : 'plus' }} "
