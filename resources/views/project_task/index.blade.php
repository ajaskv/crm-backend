                        ...
                        <div class="m-2">
                            ...
                            <div class="card-list-body task-list-items" id="task-list-{{ $stage->id }}"
                                ...
                                @foreach ($stage->tasks as $taskDetail)
                                    <div class="card card-progress draggable-item border shadow-none pb-0 mb-0"
                                        id="{{ $taskDetail->id }}"
                                        ...
                                        <div class="card-body">
                                            ...
                                            @can('view project task')
                                                <a class="h6 task-name-break" href="#"
                                                    data-url="{{ route('projects.tasks.show', [$project->id, $taskDetail->id]) }}"
                                                    data-ajax-popup="true">{{ $taskDetail->name }}</a>
                                            @endcan
                                            <div class="row align-items-center">
                                                <div class="col-12">
            ...
            if (file_data != '' && file_data != undefined) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        show_toastr('{{ __('Success') }}',
                            '{{ __('File Added Successfully!') }}', 'success');
                        ...
                        var html = '<div class="card mb-3 border shadow-none task-file">' +
                            ...
                            data.extension +
                            '.png" class="img-fluid" style="width: 40px;">' +
                            '                            </div>' +
                            '                            <div class="col ml-n2">' +
                    ...
                    error: function(data) {
                        ...
                        if (data.message) {
                            show_toastr('{{ __('Error') }}', data.errors.file[0],
                                'error');
