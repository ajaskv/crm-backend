...
@section('action-button')
    ...
    <div class="dropdown">
        <a href="#" class="btn btn-xs btn-white btn-icon-only width-auto mr-2" role="button" data-toggle="dropdown"
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-steady" id="task_sort">
            <a id="newwest" class="dropdown-item active" href="#" data-val="created_at-desc">
...
@push('script-page')
    <script>
        window.onload=function(){
            document.getElementById("newwest").click();
        };
        // ready
        $(function() {
