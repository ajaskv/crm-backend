    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('create stage')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('stages.create') }}" data-ajax-popup="true"
                    data-title="{{ __('Create Deal Stage') }}" class="btn btn-xs btn-white btn-icon-only width-auto"><i
        ...
        <div class="col-lg-12">
            <ul class="nav nav-tabs my-3">
                ...
                @foreach ($pipelines as $key => $pipeline)
                    <li>
                        <a class="@if ($i == 0) active @endif" data-toggle="tab"
                                    ...
                                    @foreach ($pipeline['stages'] as $stage)
                                        <li class="list-group-item" data-id="{{ $stage->id }}">
                                            ...
                                            <span class="float-right">
                                                @can('edit stage')
                                                    <a href="#" data-url="{{ URL::to('stages/' . $stage->id . '/edit') }}"
                                                        data-ajax-popup="true" data-title="{{ __('Edit Deal Stages') }}"
                                                ...
                                                @if (count($pipeline['stages']))
                                                    @can('delete stage')
                                                        <a href="#" class="delete-icon" data-toggle="tooltip"
                                                            ...
                                                            data-confirm-yes="document.getElementById('delete-form-{{ $stage->id }}').submit();"><i
