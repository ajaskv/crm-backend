<div class="card bg-none card-box">
    ...
    <div class="card-body">
        ...
        <dl class="row mb-0 align-items-center">
            ...
            <dd class="col-sm-9 text-sm">
                {{ \Auth::user()->dateFormat($interviewSchedule->date) . ' ' . \Auth::user()->timeFormat($interviewSchedule->time) }}
            </dd>
            <dt class="col-sm-3 h6 text-sm">{{ __('Assign Employee') }}</dt>
            <dd class="col-sm-9 text-sm">
                {{ !empty($interviewSchedule->users) ? $interviewSchedule->users->name : '-' }}</dd>
    ...
    <div class="card-body">
        <a href="#" data-url="{{ route('job.on.board.create', $interviewSchedule->candidate) }}"
