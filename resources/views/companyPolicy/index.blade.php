                                        ...
                                        <td>
                                            @if (!empty($policy->attachment))
                                                <a href="{{ $policyPath . '/' . $policy->attachment }}" target="_blank">
                                                    <img src="{{ $policyPath . '/' . $policy->attachment }}"
                                                        alt="No Attachment" width="100px" height="100px">
                                                </a>
                                            @else
                                                <p>-</p>
                                            @endif
                                        ...
                                        @if (Gate::check('edit company policy') || Gate::check('delete company policy'))
                                            <td>
                                                @can('edit company policy')
                                                    <a href="#" data-url="{{ route('company-policy.edit', $policy->id) }}"
                                                ...
                                                @can('delete company policy')
                                                    <a href="#" class="delete-icon" data-toggle="tooltip"
                                                        ...
                                                        data-confirm-yes="document.getElementById('delete-form-{{ $policy->id }}').submit();"><i
