...
@section('action-button')
    <div class="col-md-6 d-flex align-items-center justify-content-between justify-content-md-end">
        @can('create expense')
            <a href="#" class="btn btn-xs btn-white btn-icon-only width-auto ml-2"
                data-url="{{ route('projects.expenses.create', $project->id) }}" data-ajax-popup="true" data-size="lg"
                                        ...
                                        @if (Gate::check('edit expense') || Gate::check('delete expense'))
                                            <td class="text-right w-15">
                                                <div class="actions">
                                                    ...
                                                    @endcan
                                                    @can('delete expense')
                                                        <a href="#" class="action-item text-danger px-2" data-toggle="tooltip"
