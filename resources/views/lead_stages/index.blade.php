    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('create lead stage')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('lead_stages.create') }}" data-ajax-popup="true"
                    data-title="{{ __('Create Lead Stage') }}" class="btn btn-xs btn-white btn-icon-only width-auto"><i
                                            ...
                                            <span class="float-right">
                                                @can('edit lead stage')
                                                    <a href="#"
                                                        ...
                                                        data-ajax-popup="true" data-title="{{ __('Edit Lead Stages') }}"
                                                ...
                                                @if (count($pipeline['lead_stages']))
                                                    @can('delete lead stage')
                                                        <a href="#" class="delete-icon" data-toggle="tooltip"
                                                            ...
                                                            data-confirm-yes="document.getElementById('delete-form-{{ $lead_stages->id }}').submit();"><i
