...
@section('action-button')
    <div class="row d-flex justify-content-end">
        <div class="col-auto">
            ...
            {{ Form::text('start_date', $filter['start_date'], ['class' => 'month-btn form-control datepicker']) }}
        </div>
        <div class="col-auto">
            {{ Form::label('end_date', __('End Date'), ['class' => 'text-type']) }}
            {{ Form::text('end_date', $filter['end_date'], ['class' => 'month-btn form-control datepicker']) }}
        </div>
        <div class="col-auto">
            {{ Form::label('job', __('Job'), ['class' => 'text-type']) }}
            {{ Form::select('job', $jobs, $filter['job'], ['class' => 'form-control select2']) }}
        </div>

        <div class="col-auto my-custom">
            <a href="#" class="apply-btn"
                onclick="document.getElementById('applicarion_filter').submit(); return false;" data-toggle="tooltip"
