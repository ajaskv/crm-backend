                                    ...
                                    <div data-v-136bf9b5="" class="d-table">
                                        <div data-v-136bf9b5="" class="d-table">
                                            <div data-v-136bf9b5="" class="d-table-tr">
                                                ...
                                                <div data-v-136bf9b5="" class="d-table-th w-3 text-right">
                                                    {{ __('Amount') }}</div>
                                            </div>
                                            <div data-v-136bf9b5="" class="d-table-body">
                                                    ...
                                                    @foreach ($estimation->getProducts as $key => $item)
                                                        <div data-v-136bf9b5="" class="d-table-tr">
                                                            <div data-v-136bf9b5="" class="d-table-td w-2"><span
                                                                    data-v-136bf9b5="">{{ $key + 1 }}</span></div>
                                                            ...
                                                            <div data-v-136bf9b5="" class="d-table-td w-3 text-right">
                                                                <span
                                                ...
                                                @else
                                                    <div data-v-136bf9b5="" class="d-table-tr">
                                                        ...
                                                        <div data-v-136bf9b5="" class="d-table-td w-2"><span
                                                                data-v-136bf9b5="">-</span></div>
                                                        <div data-v-136bf9b5="" class="d-table-td w-3 text-right"><span
                                                                data-v-136bf9b5="">-</span></div>
                                                    </div>
                                                @endif
                                            </div>
