                                ...
                                <div data-v-1ad6e3b9="" class="d-inner d-no-pad"
                                    ...
                                    <div data-v-1ad6e3b9="" class="row grey-box">
                                        <div data-v-1ad6e3b9="" class="col-33"><img data-v-1ad6e3b9=""
                                                ...
                                                style="max-width: 200px;"> <br data-v-1ad6e3b9=""><br
                                                data-v-1ad6e3b9="">
                                            <p data-v-1ad6e3b9="">
...
@endif
                                        ...
                                        <div data-v-1ad6e3b9="" class="col-33">
                                            <h1 data-v-1ad6e3b9="" class="fancy-title mb5">{{ __('ESTIMATION') }}
                                            </h1>
                                        ...
                                        <div data-v-1ad6e3b9="" class="d-table">
                                            <div data-v-1ad6e3b9="" class="d-table">
                                                <div data-v-1ad6e3b9="" class="tu d-table-tr"
                                                    ...
                                                    <div data-v-1ad6e3b9="" class="d-table-th w-3 text-right"
                                                ...
                                                <div data-v-1ad6e3b9="" class="d-table-body">
                                                        ...
                                                        @foreach ($estimation->getProducts as $key => $item)
                                                            <div data-v-1ad6e3b9="" class="d-table-tr">
                                                                <div data-v-1ad6e3b9="" class="d-table-td w-3"
                                                                    ...
                                                                    <span data-v-1ad6e3b9="">{{ $key + 1 }}</span>
                                                                </div>
                                                                ...
                                                                <div data-v-1ad6e3b9=""
                                                                    class="d-table-td w-3 text-right"
                                                                    style="border: 1px solid {{ $color }}; padding: 5px;">
                                                                    <span
                                                    ...
                                                    @else
                                                        <div data-v-1ad6e3b9="" class="d-table-tr">
                                                            ...
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-3 text-right"
                                                                style="border: 1px solid {{ $color }}; padding: 5px;">
                                                                <span data-v-1ad6e3b9="">-</span>
                                                            </div>
                                                        </div>
