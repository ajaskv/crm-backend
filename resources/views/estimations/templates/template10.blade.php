                                    ...
                                    <div data-v-b8f60a0c="" class="d-table">
                                        <div data-v-b8f60a0c="" class="d-table">
                                            <div data-v-b8f60a0c="" class="tu d-table-tr"
                                                ...
                                                <div data-v-b8f60a0c="" class="d-table-th w-3 text-right">
                                                    {{ __('Amount') }}</div>
                                            </div>
                                            <div data-v-b8f60a0c="" class="d-table-body">
                                                    ...
                                                    @foreach ($estimation->getProducts as $key => $item)
                                                        <div data-v-b8f60a0c="" class="d-table-tr"
                                                            ...
                                                            <div data-v-b8f60a0c="" class="d-table-td w-2"><span
                                                                    data-v-b8f60a0c="">{{ $key + 1 }}</span></div>
                                                            ...
                                                            <div data-v-b8f60a0c="" class="d-table-td w-3 text-right">
                                                                <span
                                                ...
                                                @else
                                                    <div data-v-b8f60a0c="" class="d-table-tr"
                                                        ...
                                                        <div data-v-b8f60a0c="" class="d-table-td w-2"><span
                                                                data-v-b8f60a0c="">-</span></div>
                                                        <div data-v-b8f60a0c="" class="d-table-td w-3 text-right"><span
                                                                data-v-b8f60a0c="">-</span></div>
                                                    </div>
                                                @endif
                                            </div>
