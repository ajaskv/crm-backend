                                    ...
                                    <div data-v-4b3dcb8a="" class="d-table">
                                        <div data-v-4b3dcb8a="" class="d-table">
                                            <div data-v-4b3dcb8a="" class="tu d-table-tr"
                                                ...
                                                <div data-v-4b3dcb8a="" class="d-table-th w-3 text-right">
                                                    {{ __('Amount') }}</div>
                                            </div>
                                            <div data-v-4b3dcb8a="" class="d-table-body">
                                                @if (isset($estimation->getProducts) && count($estimation->getProducts) > 0)
                                                    @foreach ($estimation->getProducts as $key => $item)
                                                        <div data-v-4b3dcb8a="" class="d-table-tr"
                                                            ...
                                                            <div data-v-4b3dcb8a="" class="d-table-td w-3 text-right">
                                                                <span
                                                ...
                                                @else
                                                    <div data-v-4b3dcb8a="" class="d-table-tr"
                                                        ...
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-2"><span
                                                                data-v-4b3dcb8a="">-</span></div>
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-3 text-right"><span
                                                                data-v-4b3dcb8a="">-</span></div>
                                                    </div>
                                                @endif
                                            </div>
