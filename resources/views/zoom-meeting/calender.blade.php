        ...
        <div class="all-button-box row d-flex justify-content-end mt-2">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-12 col-12">
                <div class="all-button-box">
                    <a href="{{ route('zoom-meeting.index') }}" class="btn btn-xs btn-white btn-icon-only width-auto"><i
                            class="fas fa-list"></i> {{ __('List View') }} </a>
                </div>
            </div>
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('zoom-meeting.create') }}" data-ajax-popup="true"
                    data-title="{{ __('Create New Meeting') }}" class="btn btn-xs btn-white btn-icon-only width-auto">
    ...
    <script>
        Fullcalendar = function() {
            ...
            a.length && (t = {
                ...
                events: [{
                    "id": 1,
                    "title": "Natus tempore et ei",
                    "start": "2021-12-27",
                    "end": "2021-12-27",
                    "backgroundColor": "#FFAB00",
                    "borderColor": "#fff",
                    "textColor": "white",
                    "url": "http:\/\/localhost\/product\/rajodiya\/erpgo\/main\/erpgo_saas\/main_file\/event\/1\/edit"
                }],
                dayClick: function(e) {
