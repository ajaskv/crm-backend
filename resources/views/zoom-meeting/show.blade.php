                    ...
                    <div class="card">
                        <div class="card-body">
                            <dl class="row">
                                ...
                                <dt class="col-sm-4"><span class="h6 text-sm mb-0">{{ __('Client') }}</span>
                                </dt>
                                <dd class="col-sm-8"><span
                                        class="text-sm">{{ !empty($zoomMeeting->client_name) ? $zoomMeeting->client_name : '-' }}</span>
                                </dd>
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item px-0">
                                    <div class="row align-items-center">
                                        <dt class="col-sm-12"><span
                                                class="h6 text-sm mb-0">{{ __('Assigned Client') }}</span></dt>
                                        ...
                                        <dd class="col-sm-12"><span
                                                class="text-sm">{{ \Auth::user()->dateFormat($zoomMeeting->created_at) }}</span>
                                        </dd>
                                    </div>
                                </li>
                            </ul>
