    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('create constant tax')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('taxes.create') }}" data-ajax-popup="true"
                    data-title="{{ __('Create Tax Rate') }}" class="btn btn-xs btn-white btn-icon-only width-auto">
                                            ...
                                            <span>
                                                @can('edit constant tax')
                                                    <a href="#" class="edit-icon"
                                                        data-url="{{ route('taxes.edit', $taxe->id) }}" data-ajax-popup="true"
