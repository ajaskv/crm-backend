    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('create journal entry')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="{{ route('journal-entry.create') }}" data-title="{{ __('Create New Journal') }}"
                            ...
                            <tbody>
                                @foreach ($journalEntries as $journalEntry)
                                    <tr>
                                        <td class="Id">
                                            <a
                                                href="{{ route('journal-entry.show', $journalEntry->id) }}">{{ AUth::user()->journalNumberFormat($journalEntry->journal_id) }}</a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            @can('delete journal entry')
                                                ...
                                                {!! Form::open(['method' => 'DELETE', 'route' => ['journal-entry.destroy', $journalEntry->id], 'id' => 'delete-form-' . $journalEntry->id]) !!}
                                                {!! Form::close() !!}
                                            @endcan
                                        </td>
                                    </tr>
